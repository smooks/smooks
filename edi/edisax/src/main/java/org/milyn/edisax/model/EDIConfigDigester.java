...
import org.milyn.commons.javabean.decoders.CustomDecoder;
...
public class EDIConfigDigester {
     ...
     *          is thrown when unable to retrieve namespace in configuration.
     */
     ...
     * @throws org.milyn.edisax.EDIConfigurationException
     *          is thrown when values are badly formatted.
     */
...
//                }
     ...
     * @throws org.milyn.edisax.EDIConfigurationException
     *          is thrown when no namespace exists in configuration.
     */
