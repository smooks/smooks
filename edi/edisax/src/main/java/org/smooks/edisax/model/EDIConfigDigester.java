...
import org.smooks.edisax.EDITypeEnum;
...
import org.smooks.edisax.model.internal.ParamEntry;
...
/**
 * Digests an edi-message-mapping and populates a {@link org.smooks.edisax.model.internal.Edimap}.
 *
 * @author bardl
 */
public class EDIConfigDigester {
     ...
     * @return the {@link org.smooks.edisax.model.internal.Edimap}.
     ...
     * @param edimap the {@link org.smooks.edisax.model.internal.Edimap} to populate.
     * @param schemaName the schema uri.
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when unable to retrieve namespace in configuration.
     */
     ...
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
     ...
     * @param segmentGroup the {@link org.smooks.edisax.model.internal.SegmentGroup} to populate.
     * @param namespacePrefix the prefix used to name elements in xml.
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
     ...
     * @param field the {@link org.smooks.edisax.model.internal.Field} to populate
     * @param namespacePrefix the prefix used to name elements in xml.
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
     ...
     * @param component the {@link org.smooks.edisax.model.internal.Component} to populate.
     * @param namespacePrefix the prefix used to name elements in xml.
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
    ...
    /**
     * Set values in {@link org.smooks.edisax.model.internal.Segment}.
     * @param segment the {@link org.smooks.edisax.model.internal.Segment} to populate.
     * @param node the Segment element.
     */
    ...
    /**
     * Set values in {@link org.smooks.edisax.model.internal.Field}.
     * @param field the {@link org.smooks.edisax.model.internal.Field} to populate.
     * @param node the Field element.
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
    ...
    /**
     * Set values in {@link org.smooks.edisax.model.internal.Component}.
     * @param component the {@link org.smooks.edisax.model.internal.Component} to populate.
     * @param node the Component element.
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
    ...
    /**
     * Set values in {@link org.smooks.edisax.model.internal.SubComponent}.
     * @param node the {@link org.smooks.edisax.model.internal.SubComponent} to populate.
    ...
    /**
     * Set values in {@link org.smooks.edisax.model.internal.MappingNode}.
     * @param node the {@link org.smooks.edisax.model.internal.MappingNode} to populate.
    ...
    /**
     * Set values in {@link org.smooks.edisax.model.internal.ValueNode}.
     * @param node the {@link org.smooks.edisax.model.internal.ValueNode} to populate.
...
//                }
     ...
     * @throws org.smooks.edisax.EDIConfigurationException is thrown when no namespace exists in configuration.
     */
