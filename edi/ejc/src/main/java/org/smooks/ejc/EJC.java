...
import static org.smooks.ejc.EJCLoggerFactory.Level;
 ...
 * <ol>
 * <li>{@link ClassModelCompiler} - parse a edi-mapping-file a creates a {@link org.smooks.ejc.ClassModel}.</li>
 * <li>{@link org.smooks.ejc.BeanWriter} - generates javaimplementation from {@link org.smooks.ejc.ClassModel}.</li>
 * <li>{@link org.smooks.ejc.BindingWriter} - generates a bindingfile from {@link org.smooks.ejc.ClassModel}.</li>
 * </ol>
 *
...
public class EJC {
    ...
    /**
     * Add the {@link EDIMessage} annotation to the
     ...
     * 1. {@link ClassModelCompiler} - parse a edi-mapping-file a creates a {@link org.smooks.ejc.ClassModel}.
     * 2. {@link org.smooks.ejc.BeanWriter} - generates javaimplementation from {@link org.smooks.ejc.ClassModel}.
     * 3. {@link org.smooks.ejc.BindingWriter} - generates a bindingfile from {@link org.smooks.ejc.ClassModel}.
     ...
     * @throws org.smooks.edisax.EDIConfigurationException when error occurs while reading ediConfiguration.
