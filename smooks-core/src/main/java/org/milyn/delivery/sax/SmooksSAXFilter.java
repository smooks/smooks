...
public class SmooksSAXFilter extends Filter {
    ...
    public synchronized void doFilter() throws SmooksException {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                if (e.isTerminateBefore()) {
                    logger.info("Terminated filtering on visitBefore of element '" + SAXUtil.getXPath(e.getElement()) + "'.");
                } else {
                    logger.info("Terminated filtering on visitAfter of element '" + SAXUtil.getXPath(e.getElement()) + "'.");
                }
            }
        } catch (Exception e) {
            logger.info("Exception in smooks", e);
