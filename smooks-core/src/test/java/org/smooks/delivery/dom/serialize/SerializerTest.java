...
public class SerializerTest {
	...
	public void testSerialize() {
		...
		((MockContentDeliveryConfig)executionContext.deliveryConfig).getSerializationVisitors().addMapping(SmooksResourceConfiguration.DOCUMENT_FRAGMENT_SELECTOR, configuration, Configurator.configure(addAttributeSerializer, new Scope(executionContext.getApplicationContext(), configuration, addAttributeSerializer), executionContext.getApplicationContext().getRegistry()));
		...
		((MockContentDeliveryConfig)executionContext.deliveryConfig).getSerializationVisitors().addMapping("xxx", configuration, Configurator.configure(removeTestSerializationUnit, new Scope(executionContext.getApplicationContext(), configuration, removeTestSerializationUnit), executionContext.getApplicationContext().getRegistry()));
		...
		((MockContentDeliveryConfig)executionContext.deliveryConfig).getSerializationVisitors().addMapping("yyyy", configuration, Configurator.configure(emptyElTestSerializationUnit, new Scope(executionContext.getApplicationContext(), configuration, emptyElTestSerializationUnit), executionContext.getApplicationContext().getRegistry()));
		...
		((MockContentDeliveryConfig)executionContext.deliveryConfig).getSerializationVisitors().addMapping("zzz", configuration, Configurator.configure(otherEmptyElTestSerializationUnit, new Scope(executionContext.getApplicationContext(), configuration, otherEmptyElTestSerializationUnit), executionContext.getApplicationContext().getRegistry()));
