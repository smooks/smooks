...
package org.smooks.rules.regex;
...
public class RegexProviderTest
{
    ...
    public void test_Multiple_Providers() {
        ...
        productsProvider.setSrc("/org/smooks/rules/regex/rules-products.properties");
        ordersProvider.setSrc("/org/smooks/rules/regex/rules-orders.properties");
