...
*/
package org.milyn.cartridge.javabean.programatic;

import com.google.common.io.Resources;
import junit.framework.TestCase;
import org.milyn.Smooks;
import org.milyn.cartridge.javabean.Order;
...
public class ProgrammaticValueConfigTest extends TestCase {
    ...
    public void test_01() throws IOException {
        ...
        smooks.filterSource(new StreamSource(Resources.getResource(Order.class,"order-01.xml").openStream()), result);
