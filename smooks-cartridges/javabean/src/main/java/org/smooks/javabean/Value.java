...
import org.smooks.javabean.ext.SelectorPropertyResolver;
...
public class Value extends BindingAppender {
	...
	/**
	 * The {@link org.smooks.javabean.DataDecoder} to be used for decoding
     * the data value.
	 *
	 * @param targetNamespace The {@link org.smooks.javabean.DataDecoder}
	 * @return <code>this</code> Value configuration instance.
	 */
