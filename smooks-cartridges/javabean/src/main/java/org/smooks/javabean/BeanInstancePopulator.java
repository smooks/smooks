...
import org.smooks.javabean.observers.BeanWiringObserver;
import org.smooks.javabean.observers.ListToArrayChangeObserver;
...
public class BeanInstancePopulator implements DOMElementVisitor, SAXVisitBefore, SAXVisitAfter, Producer, Consumer {
    ...
    public static final String NOTIFY_POPULATE = "org.smooks.javabean.notify.populate";
