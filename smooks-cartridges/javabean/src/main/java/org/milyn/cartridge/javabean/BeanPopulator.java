...
import org.milyn.cartridge.javabean.ext.SelectorPropertyResolver;
...
public class BeanPopulator implements ConfigurationExpander {
    ...
    public static String DEFAULT_FACTORY_DEFINITION_PARSER_CLASS = org.milyn.cartridge.javabean.factory.BasicFactoryDefinitionParser.class.getCanonicalName();
