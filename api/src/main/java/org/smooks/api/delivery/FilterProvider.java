 ...
 * calling {@link #createContentDeliveryConfig(List, ApplicationContext, Map, List, Boolean)}
 * by calling {@link #isProvider(List)}. A <code>FilterProvider</code> that is not a provider will return an empty
 * <code>ContentDeliveryConfig</code> in {@link #createContentDeliveryConfig(List, ApplicationContext, Map, List, Boolean)}.
 */
