 ...
 * <p/>
 * A producer is a {@link Visitor} that "produces" a named object that is added to the
 * {@link ExecutionContext} for use by a {@link Consumer} of some sort.  Note that a {@link Visitor}
 ...
 * {@link Visitor} instances, targetted at the same element selector, based on what the {@link Visitor}
