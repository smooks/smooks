...
*/
package org.milyn.commons.archive;
...
public class ArchiveTest extends TestCase {
    ...
    public void test_produced_zip() throws IOException {
        ...
        assertEquals("org/milyn/commons/archive/Archive.class", archive.getEntryName(2));
        ...
        // Archive.class
        zipEntry = zipInputStream.getNextEntry();
        assertEquals("org/milyn/commons/archive/Archive.class", zipEntry.getName());
    }
    ...
    public void test_toFileSystem() throws IOException {
        ...
        assertTrue(new File(folder, "org/milyn/commons/archive/Archive.class").exists());
    }
