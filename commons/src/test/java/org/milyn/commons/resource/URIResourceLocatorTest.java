...
public class URIResourceLocatorTest extends TestCase {
    ...
    public void test_fileBasedResource() throws IllegalArgumentException, IOException, URISyntaxException {
        ...
        stream = locator.getResource("src/test/java/org/milyn/commons/resource/somefile.txt");
        assertNotNull(stream);

        // Try it again now with a non-default base URI...
        locator.setBaseURI(new URI("src/test"));
        stream = locator.getResource("java/org/milyn/commons/resource/somefile.txt");
        assertNotNull(stream);
    }
    ...
    public void test_classpathBasedResource() throws IllegalArgumentException, IOException {
        ...
        try {
            stream = locator.getResource("classpath:/org/milyn/commons/resource/someunknownfile.txt");
        ...
        // Resource exists...
        stream = locator.getResource("classpath:/org/milyn/commons/resource/somefile.txt");
        assertNotNull(stream);

        // Resource exists - no scheme - should get it from the classpath ...
        stream = locator.getResource("/org/milyn/commons/resource/somefile.txt");
        assertNotNull(stream);
    }
