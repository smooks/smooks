 ...
 */
public class CalendarProviderFactoryTest {
	...
	public void test_CalendarDecoder() {
		...
		CalendarProviderFactory calendarProviderFactory = new CalendarProviderFactory();
	    ...
	    calendarProviderFactory.setConfiguration(config);

	    Calendar cal_a = calendarProviderFactory.createProvider("Wed Nov 15 13:45:28 EST 2006").get();
	    ...
	    Calendar cal_b = calendarProviderFactory.createProvider("Wed Nov 15 13:45:28 EST 2006").get();
	...
	public void test_CalendarDecoder_with_swedish_local() throws ParseException {
		...
		Calendar cal_a = calendarProviderFactory.createProvider(dateString).get();
	    assertEquals("Centraleuropeisk tid", cal_a.getTimeZone().getDisplayName( new Locale("sv", "SE") ) );

		Calendar cal_b = calendarProviderFactory.createProvider(dateString).get();
	    assertNotSame(cal_a, cal_b);
	}
