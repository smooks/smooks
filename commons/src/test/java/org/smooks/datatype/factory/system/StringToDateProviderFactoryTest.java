 ...
 */
public class StringToDateProviderFactoryTest {
    
    private Locale defaultLocale;

    @Test
    public void test_DateDecoder_01() {
        StringToDateProviderFactory stringToDateProviderFactory = new StringToDateProviderFactory();
        ...
        stringToDateProviderFactory.setConfiguration(config);

        Date date_a = stringToDateProviderFactory.createProvider("Wed Nov 15 13:45:28 EST 2006").get();
        assertEquals(1163616328000L, date_a.getTime());
        Date date_b = stringToDateProviderFactory.createProvider("Wed Nov 15 13:45:28 EST 2006").get();
