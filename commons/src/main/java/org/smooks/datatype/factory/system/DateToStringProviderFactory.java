 ...
 */
public class DateToStringProviderFactory implements DataTypeProviderFactory<Date, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(Date value) {
        final LocaleAwareDateToStringProviderFactory<Date> localeAwareStringToDateProviderFactory = new LocaleAwareDateToStringProviderFactory<Date>() {
            @Override
            protected Provider<String> doCreateProvider(String value) {
                return () -> value;
            }
        };
