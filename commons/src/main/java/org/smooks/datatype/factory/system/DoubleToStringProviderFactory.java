 ...
 */
public class DoubleToStringProviderFactory implements DataTypeProviderFactory<Double, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(Double value) {
        final NumberToStringProviderFactory<Double> numberProviderFactory = new NumberToStringProviderFactory<>();
