 ...
 */
public class BigDecimalToStringProviderFactory implements DataTypeProviderFactory<BigDecimal, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(BigDecimal value) {
        final NumberToStringProviderFactory<BigDecimal> numberProviderFactory = new NumberToStringProviderFactory<>();
