 ...
 */
public class BigIntegerToStringProviderFactory implements DataTypeProviderFactory<BigInteger, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(BigInteger value) {
        final NumberToStringProviderFactory<BigInteger> numberProviderFactory = new NumberToStringProviderFactory<>();
