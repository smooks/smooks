 ...
 */
public class StringToDateProviderFactory implements DataTypeProviderFactory<String, Date>, Configurable {

    private Properties config;

    @Override
    public Provider<Date> createProvider(final String value) {
        final LocaleAwareStringToDateProviderFactory<Date> localeAwareStringToDateProviderFactory = new LocaleAwareStringToDateProviderFactory<Date>() {
            @Override
            protected Provider<Date> doCreateProvider(final Date date) {
                return () -> date;
            }
        };
