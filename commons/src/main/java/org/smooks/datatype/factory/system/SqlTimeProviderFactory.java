 ...
 */
public class SqlTimeProviderFactory implements DataTypeProviderFactory<String, Time>, Configurable {

    private Properties config;
    
    @Override
    public Provider<Time> createProvider(String value) {
        final LocaleAwareStringToDateProviderFactory<Time> localeAwareStringToDateProviderFactory = new LocaleAwareStringToDateProviderFactory<Time>() {
            @Override
            protected Provider<Time> doCreateProvider(final Date date) {
