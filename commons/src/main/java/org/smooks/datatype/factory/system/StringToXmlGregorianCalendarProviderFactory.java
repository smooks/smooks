 ...
 */
public class StringToXmlGregorianCalendarProviderFactory implements DataTypeProviderFactory<String, XMLGregorianCalendar>, Configurable {

    private Properties config;

    @Override
    public Provider<XMLGregorianCalendar> createProvider(final String value) {
        LocaleAwareStringToDateProviderFactory<XMLGregorianCalendar> localeAwareStringToDateProviderFactory = new LocaleAwareStringToDateProviderFactory<XMLGregorianCalendar>() {
            @Override
            protected Provider<XMLGregorianCalendar> doCreateProvider(final Date date) {
                return () -> {
                    try {
                        ...
                        throw new DataDecodeException("Error decoding XMLGregorianCalendar data value '" + value + "' with decode format '" + format + "'.", e);
                    }
                };
            }
        };
