...
*/
public class SqlTimestampProviderFactory implements DataTypeProviderFactory<String, Timestamp>, Configurable
{
	private Properties config;

	@Override
	public Provider<Timestamp> createProvider(final String value) {
		final LocaleAwareStringToDateProviderFactory<Timestamp> localeAwareStringToDateProviderFactory = new LocaleAwareStringToDateProviderFactory<Timestamp>() {
			@Override
			protected Provider<Timestamp> doCreateProvider(final Date date) {
