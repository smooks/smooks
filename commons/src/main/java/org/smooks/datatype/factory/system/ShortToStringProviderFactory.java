 ...
 *
 */
public class ShortToStringProviderFactory implements DataTypeProviderFactory<Short, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(final Short value) {
        final NumberToStringProviderFactory<Short> numberProviderFactory = new NumberToStringProviderFactory<>();
