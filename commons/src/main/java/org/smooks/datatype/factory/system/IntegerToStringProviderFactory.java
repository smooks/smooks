 ...
 */
public class IntegerToStringProviderFactory implements DataTypeProviderFactory<Integer, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(Integer value) {
        final NumberToStringProviderFactory<Integer> numberProviderFactory = new NumberToStringProviderFactory<>();
