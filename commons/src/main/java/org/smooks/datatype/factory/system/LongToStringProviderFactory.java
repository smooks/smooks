 ...
 */
public class LongToStringProviderFactory implements DataTypeProviderFactory<Long, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(Long value) {
        final NumberToStringProviderFactory<Long> numberProviderFactory = new NumberToStringProviderFactory<>();
