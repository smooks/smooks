 ...
 */
public abstract class LocaleAwareDataTypeProviderFactory<S, T> implements DataTypeProviderFactory<S, T>, Configurable {
     ...
     * will be returned.
     * @throws SmooksConfigurationException if the Locale is not installed on the system
     */
