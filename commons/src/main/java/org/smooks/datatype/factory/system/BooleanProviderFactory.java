...
public class BooleanProviderFactory implements DataTypeProviderFactory<String, Boolean> {
    ...
    @Override
    public Provider<Boolean> createProvider(final String value) {
        return () -> {
            ...
            try {
                ...
                throw new DataDecodeException("Failed to decode Boolean value '" + value + "'.", e);
            }
        };
    }
}
