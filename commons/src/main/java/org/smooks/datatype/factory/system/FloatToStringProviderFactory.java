 ...
 */
public class FloatToStringProviderFactory implements DataTypeProviderFactory<Float, String>, Configurable {

    private Properties config;

    @Override
    public Provider<String> createProvider(Float value) {
        final NumberToStringProviderFactory<Float> numberProviderFactory = new NumberToStringProviderFactory<>();
