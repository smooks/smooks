...
public class StringToLongConverterFactory implements TypeConverterFactory<String, Long> {
            ...
            protected Long doConvert(String value) {
                if (numberFormat != null) {
                    try {
                        ...
                        throw new TypeConverterException("Failed to decode Long value '" + value + "' using NumberFormat instance " + numberFormat + ".", e);
                    }
                } else {
                    try {
                        return Long.parseLong(value.trim());
                    } catch (NumberFormatException e) {
                        throw new TypeConverterException("Failed to decode Long value '" + value + "'.", e);
                    }
                }
            }
    ...
    public TypeConverterDescriptor<Class<String>, Class<Long>> getTypeConverterDescriptor() {
        return new TypeConverterDescriptor<>(String.class, Long.class);
    }
}
