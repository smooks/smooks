...
public abstract class HTMLEntityLookup {
     ...
     * @param charCode   The entity's value
     */
     ...
     *
     * @param entityName The entity name for the character code being sought.
     ...
     *
     * @param charCode The character code of the entity reference name being sought.
