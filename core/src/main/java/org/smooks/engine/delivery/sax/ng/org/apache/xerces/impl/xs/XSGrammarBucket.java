...
public class XSGrammarBucket {
    ...
    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar fNoNSGrammar = null;
     ...
     */
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar getGrammar(String namespace) {
        if (namespace == null)
            return fNoNSGrammar;
        return (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar)fGrammarRegistry.get(namespace);
    }
     ...
     */
    public void putGrammar(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar grammar) {
     ...
     */
    public boolean putGrammar(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar grammar, boolean deep) {
        // whether there is one with the same tns
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar sg = getGrammar(grammar.fTargetNamespace);
        if (sg != null) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar sg1, sg2;
        Vector gs;
        // for all (recursively) imported grammars
        for (int i = 0; i < grammars.size(); i++) {
            // get the grammar
            sg1 = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar)grammars.elementAt(i);
            ...
            if (sg2 == null) {
                ...
                for (int j = gs.size() - 1; j >= 0; j--) {
                    sg2 = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar)gs.elementAt(j);
        ...
        for (int i = grammars.size() - 1; i >= 0; i--)
            putGrammar((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar)grammars.elementAt(i));
     ...
     * @return               whether the process succeeded
     */
    public boolean putGrammar(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar grammar, boolean deep, boolean ignoreConflict) {
        if (!ignoreConflict) {
     ...
     */
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar[] getGrammars() {
        // get the number of grammars
        int count = fGrammarRegistry.size() + (fNoNSGrammar==null ? 0 : 1);
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar[] grammars = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar[count];
