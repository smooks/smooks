 ...
 * @version $Id$
 */
public class CMBinOp extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode
{
    // -------------------------------------------------------------------
    //  Constructors
    // -------------------------------------------------------------------
    public CMBinOp(int type, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode leftNode, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode rightNode) 
    {
        super(type);
    ...
    // -------------------------------------------------------------------
    final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode getLeft()
    {
        return fLeftChild;
    }

    final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode getRight()
    {
        return fRightChild;
    }
    ...
    // -------------------------------------------------------------------
    private final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode fLeftChild;
