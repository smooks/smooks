...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMAny;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMUniOp;
...
public class DFAContentModel
     ...
     */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet fFollowList[] = null;
     ...
     */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode fHeadNode = null;
     ...
     */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf fLeafList[] = null;
     ...
     *
     */
    public DFAContentModel(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode syntaxTree, int leafCount, boolean mixed) {
     ...
     */
    private void buildDFA(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode syntaxTree) 
    {
        //
	 ...
	 */
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf nodeEOC = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf(fQName);
        fHeadNode = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp
        (
        ...
        //
        fLeafList = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf[fLeafCount];
        ...
        //
        fFollowList = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet[fLeafCount];
        for (int index = 0; index < fLeafCount; index++)
            fFollowList[index] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet(fLeafCount);
	...
	**/
	...
	/* Optimization(Jan, 2001) */
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet[] statesToDo = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet[curArraySize];
        ...
        //  and the EOC node.)
        //
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet setT = fHeadNode.firstPos();
        ...
        while (unmarkedState < curState)
        {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet newSet = null;
	    /* Optimization(Jan, 2001) */
            int sorterIndex = 0;
	    /* Optimization(Jan, 2001) */
            for (int elemIndex = 0; elemIndex < fElemMapSize; elemIndex++)
            {
                ...
                //
                if (newSet == null)
                    newSet = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet(fLeafCount);
                else
                    newSet.zeroBits();
	    ...
	    /* Optimization(Jan, 2001) */
                    ...
                    if (curState == curArraySize)
                    {
                        ...
                        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet[] newToDo = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet[newSize];
        ...
        fEmptyContentIsValid = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)fHeadNode).getLeft().isNullable();
     ...
     */
    private void calcFollowList(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode nodeCur) 
    {
        // Recurse as required
        if (nodeCur.type() == XMLContentSpec.CONTENTSPECNODE_CHOICE)
        {
            // Recurse only
            calcFollowList(((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)nodeCur).getLeft());
            calcFollowList(((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)nodeCur).getRight());
        }
         else if (nodeCur.type() == XMLContentSpec.CONTENTSPECNODE_SEQ)
        {
            ...
            //
            final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet last  = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)nodeCur).getLeft().lastPos();
            final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet first = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)nodeCur).getRight().firstPos();
        ...
        {
            // Recurse first
            calcFollowList(((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMUniOp)nodeCur).getChild());

            //
            //  Now handle our level. We use our own first and last position
            //  sets, so get them up front.
            //
            final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMStateSet first = nodeCur.firstPos();
            final CMStateSet last  = nodeCur.lastPos();
     ...
     */
    private void dumpTree(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode nodeCur, int level) 
    {
        ...
        ||  (type == XMLContentSpec.CONTENTSPECNODE_SEQ))
        {
            ...
            dumpTree(((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)nodeCur).getLeft(), level+1);
            dumpTree(((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)nodeCur).getRight(), level+1);
        }
         else if (nodeCur.type() == XMLContentSpec.CONTENTSPECNODE_ZERO_OR_MORE)
        {
            ...
            dumpTree(((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMUniOp)nodeCur).getChild(), level+1);
        }
         else if (nodeCur.type() == XMLContentSpec.CONTENTSPECNODE_LEAF)
        {
            ...
            (
                "Leaf: (pos="
                + ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf)nodeCur).getPosition()
                + "), "
                + ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf)nodeCur).getElement()
                + "(elemIndex="
                + ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf)nodeCur).getElement()
                + ") "
            );
    ...
    private int postTreeBuildInit(CMNode nodeCur, int curIndex) 
    {
        ...
        if ((nodeCur.type() & 0x0f) == XMLContentSpec.CONTENTSPECNODE_ANY ||
            ...
            QName qname = new QName(null, null, null, ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMAny)nodeCur).getURI());
            fLeafList[curIndex] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf(qname, ((CMAny)nodeCur).getPosition());
        ...
        {
            curIndex = postTreeBuildInit(((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMBinOp)nodeCur).getLeft(), curIndex);
         ...
         else if (nodeCur.type() == XMLContentSpec.CONTENTSPECNODE_LEAF)
        {
            ...
            //  a non-epsilon leaf.
            //
             final QName node = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMLeaf)nodeCur).getElement();
