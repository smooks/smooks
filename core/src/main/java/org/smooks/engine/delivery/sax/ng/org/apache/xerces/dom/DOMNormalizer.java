...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttributeMap;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLDTDValidator;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.SimpleLocator;
...
public class DOMNormalizer implements XMLDocumentHandler {
     ...
     */
    private final org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMErrorImpl fError = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMErrorImpl();
    ...
    protected Node normalizeNode (Node node){
        ...
        case Node.ELEMENT_NODE: {  
                ...
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl elem = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl)node;
                if (elem.needsSyncChildren()) {
                    elem.synchronizeChildren();
                }
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttributeMap attributes = (elem.hasAttributes()) ? (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttributeMap) elem.getAttributes() : null; 
                ...
                if ((fConfiguration.features & DOMConfigurationImpl.NAMESPACES) !=0) {
                    ...
                    if ((fConfiguration.features & DOMConfigurationImpl.NSDECL) == 0) {
                        ...
                        // to namespace fix-up.
                        if (attributes == null) {
                            attributes = (elem.hasAttributes()) ? (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttributeMap) elem.getAttributes() : null;
                        }
                        if (attributes != null) {
                ...
                if ((fConfiguration.features & DOMConfigurationImpl.COMMENTS) == 0) {
                    ...
                    if (prevSibling != null && prevSibling.getNodeType() == Node.TEXT_NODE) {
                        ...
                        if (nextSibling != null && nextSibling.getNodeType() == Node.TEXT_NODE) {
                            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.TextImpl)nextSibling).insertData(0, prevSibling.getNodeValue());
                    ...
                    if (nextType == -1 || !(((fConfiguration.features & DOMConfigurationImpl.ENTITIES) == 0 &&
                        ...
                        if (fValidationHandler != null) {
                            ...
                            if (!fNamespaceValidation) {
                                if (fAllWhitespace) {
                                    fAllWhitespace = false;
                                    ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.TextImpl)node).setIgnorableWhitespace(true);
                                }
                                else {
    ...
    protected final void namespaceFixUp (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl element, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttributeMap attributes){
        if (DEBUG) {
            ...
            for (int i = 0; i < fAttributeList.size(); i++) {
                ...
                if (uri != null) {  // attribute has namespace !=null
                    ...
                    */
                    ...
                    // reset id-attributes
                    ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)attr).setIdAttribute(false);
    ...
    protected final void addNamespaceDecl(String prefix, String uri, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl element){
        if (DEBUG) {
     ...
     */
    public static final void isCDataWF(DOMErrorHandler errorHandler, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMErrorImpl error, DOMLocatorImpl locator,
     ...
     * @param isXML11Version = true if XML 1.1
     */
    public static final void isXMLCharWF(DOMErrorHandler errorHandler, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMErrorImpl error, DOMLocatorImpl locator,
                                         String datavalue, boolean isXML11Version)
    {
        if ( datavalue == null || (datavalue.length() == 0) ) {
            return;      
     ...
     * @param isXML11Version = true if XML 1.1
     */
    public static final void isCommentWF(DOMErrorHandler errorHandler, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMErrorImpl error, DOMLocatorImpl locator,
                                         String datavalue, boolean isXML11Version)
    {
        if ( datavalue == null || (datavalue.length() == 0) ) {
            return;
     ...
     * @param value
     */
    public static final void isAttrValueWF(DOMErrorHandler errorHandler, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMErrorImpl error, 
            DOMLocatorImpl locator, NamedNodeMap attributes, Attr a, String value, boolean xml11Version) {
        if (a instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl && ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)a).hasStringValue()) {
    ...
    implements XMLAttributes {
        protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttributeMap fAttributes;
        protected CoreDocumentImpl fDocument;
        protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl fElement;

        protected final Vector fDTDTypes = new Vector(5);
        protected final Vector fAugmentations = new Vector(5);

        public void setAttributes(AttributeMap attributes, CoreDocumentImpl doc, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl elem) {
            fDocument = doc;
        ...
        public int addAttribute(QName qname, String attrType, String attrValue) {
            ...
            if (index < 0) {
                ...
                // be added back
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)
        ...
        public void setValue(int attrIndex, String attrValue) {
            ...
            if (fAttributes != null){
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)fAttributes.getItem(attrIndex);
    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs)
        ...
        for (int i = 0; i < attrCount; i++) {
            ...
            if (attrPSVI != null) {
                ...
                if (id) {
                    ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl)currentElement).setIdAttributeNode(attr, true);
                }
                ...
                ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) attr).setType(decl);
                ...
                if ((fConfiguration.features & DOMConfigurationImpl.DTNORMALIZATION) != 0) {
                    ...
                    if (normalizedValue != null) {
                        ...
                        if (!specified) {
                            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) attr).setSpecified(specified);
                        }
                    }
                }
            }
    ...
    public void endElement(QName element, Augmentations augs) throws XNIException {
        ...
        if (augs != null) {
            ...
            if (elementPSVI != null) {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl elementNode = (ElementImpl) fCurrentNode;
                if (fPSVI) {
