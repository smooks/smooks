...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.DOMParserImpl;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xml.serialize.DOMSerializerImpl;
import org.w3c.dom.*;
...
public class CoreDOMImplementationImpl
    ...
    final void checkQName(String qname){
        ...
        if (index == 0 || index == length - 1 || lastIndex != index) {
            String msg =
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMMessageFormatter.formatMessage(
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMMessageFormatter.DOM_DOMAIN,
                    "NAMESPACE_ERR",
                    null);
	...
	public Document createDocument(
		...
		org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDocumentImpl doc = createDocument(doctype);
	...
	protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDocumentImpl createDocument(DocumentType doctype) {
    ...
    public LSSerializer createLSSerializer() {
        try {
            Class serializerClass = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ObjectFactory.findProviderClass(
	...
	synchronized RevalidationHandler getValidator(String schemaType, String xmlVersion) {
        if (schemaType == XMLGrammarDescription.XML_SCHEMA) {
            ...
            return (RevalidationHandler) (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ObjectFactory
                    .newInstance(
                        "org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XMLSchemaValidator",
                        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ObjectFactory.findClassLoader(),
                        true));
        }
    ...
    synchronized final XMLDTDLoader getDTDLoader(String xmlVersion) {
        ...
        if ("1.1".equals(xmlVersion)) {
            ...
            return (XMLDTDLoader) (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ObjectFactory
                    .newInstance(
