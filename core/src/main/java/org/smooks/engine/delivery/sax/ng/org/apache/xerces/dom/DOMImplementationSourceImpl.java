...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDOMImplementationImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMImplementationImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMImplementationListImpl;
...
public class DOMImplementationSourceImpl
    ...
    public DOMImplementation getDOMImplementation(String features) {
        ...
        DOMImplementation impl =
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDOMImplementationImpl.getDOMImplementation();
        if (testImpl(impl, features)) {
            return impl;
        }
        // if not try the DOMImplementation
        impl = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMImplementationImpl.getDOMImplementation();
        if (testImpl(impl, features)) {
            return impl;
        }
