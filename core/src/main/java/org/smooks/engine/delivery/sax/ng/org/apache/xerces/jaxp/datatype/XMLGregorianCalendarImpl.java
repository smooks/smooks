...
package org.smooks.engine.delivery.sax.ng.org.apache.xerces.jaxp.datatype;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.jaxp.datatype.DurationImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.jaxp.datatype.SerializedXMLGregorianCalendar;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.DatatypeMessageFormatter;
...
class XMLGregorianCalendarImpl
    ...
    private XMLGregorianCalendar normalizeToTimezone(XMLGregorianCalendar cal, int timezone) {
        ...
        // addition.
        minutes = -minutes;
        Duration d = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.jaxp.datatype.DurationImpl(minutes >= 0, // isPositive
                0, //years
                0, //months
                0, //days
                0, //hours
    ...
    public void add(Duration duration) {
        ...
        BigDecimal dSeconds = org.smooks.engine.delivery.sax.ng.org.apache.xerces.jaxp.datatype.DurationImpl.sanitize((BigDecimal) duration.getField(DatatypeConstants.SECONDS), signum);
