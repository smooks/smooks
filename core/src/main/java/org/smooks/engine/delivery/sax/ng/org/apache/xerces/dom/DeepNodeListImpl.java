...
public class DeepNodeListImpl 
    ...
    protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl rootNode; // Where the search started
    ...
    /** Constructor. */
    public DeepNodeListImpl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl rootNode, String tagName) {
    ...
    public DeepNodeListImpl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl rootNode,
    ...
    protected Node nextMatchingElementAfter(Node current) {
	    ...
	    while (current != null) {
			...
			if (!enableNS) {
			    if (tagName.equals("*") ||
				((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl) current).getTagName().equals(tagName))
			    {
				return current;
			    }
			} else {
				...
				if (nsName != null && nsName.equals("*")) {
				    ...
				    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl el = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl) current;
				    if ((nsName == null
				...
				org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl el = (ElementImpl) current;
