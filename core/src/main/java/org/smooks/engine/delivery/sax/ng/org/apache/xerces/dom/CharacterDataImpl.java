...
public abstract class CharacterDataImpl
    ...
    /** Factory constructor. */
    protected CharacterDataImpl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDocumentImpl ownerDocument, String data) {
        super(ownerDocument);
        this.data = data;
    }
   ...
   /** Convenience wrapper for calling setNodeValueInternal when 
    ...
    protected void setNodeValueInternal(String value, boolean replace) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDocumentImpl ownerDocument = ownerDocument();
