...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.*;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.AttrImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl;
...
public class SchemaDOM extends DefaultDocument {
    ...
    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl[][] relations;
    ...
    private void resizeRelations() {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl[][] temp = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl[relations.length+relationsRowResizeFactor][];
        System.arraycopy(relations, 0, temp, 0, relations.length);
        for (int i = relations.length ; i < temp.length ; i++) {
            temp[i] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl[relationsColResizeFactor];
        }
        relations = temp;
    }
    
    private void resizeRelations(int i) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl[] temp = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl[relations[i].length+relationsColResizeFactor];
        ...
        if(relations != null) 
            for(int i=0; i<relations.length; i++) 
                for(int j=0; j<relations[i].length; j++) 
                    relations[i][j] = null;
        relations = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl[relationsRowResizeFactor][];
