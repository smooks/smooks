...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.XPath;
    ...
    public static void main(String[] argv) throws XNIException {
        ...
        if (DEBUG_ANY) {
            for (int i = 0; i < argv.length; i++) {
                ...
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.SAXParser parser =
                    new org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.SAXParser(symbols) {
