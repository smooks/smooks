...
public class DocumentTypeImpl 
    ...
    */
    ...
    public DocumentTypeImpl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDocumentImpl ownerDocument, String name) {
        super(ownerDocument);
    ...
    /** Factory method for creating a document type node. */
    public DocumentTypeImpl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDocumentImpl ownerDocument,
    ...
    public boolean isEqualNode(Node arg) {
        ...
        if (entities != null && argEntities != null) {
            ...
            for (int index = 0; entities.item(index) != null; index++) {
                ...
                if (!((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) entNode1).isEqualNode(entNode2))
                    return false;
            }
        }
        ...
        if (notations != null && argNotations != null) {
            ...
            for (int index = 0; notations.item(index) != null; index++) {
                ...
                if (!((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) noteNode1).isEqualNode(noteNode2))
                    return false;
            }
        }
