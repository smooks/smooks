...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.SAXLocatorWrapper;
...
final class ValidatorHandlerImpl extends ValidatorHandler implements
    DTDHandler, EntityState, PSVIProvider, org.smooks.engine.delivery.sax.ng.org.apache.xerces.jaxp.validation.ValidatorHelper, XMLDocumentHandler {
            ...
            try {
                ...
                if (reader == null) {
                    ...
                    try {
                        ...
                        if (reader instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.SAXParser) {
