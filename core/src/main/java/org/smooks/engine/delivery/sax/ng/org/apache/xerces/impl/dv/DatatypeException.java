...
public class DatatypeException extends Exception {
    ...
    public String getMessage() {
        ...
        resourceBundle = ResourceBundle.getBundle("org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.msg.XMLSchemaMessages");
        if (resourceBundle == null)
            throw new MissingResourceException("Property file not found!", "org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.msg.XMLSchemaMessages", key);

        String msg = resourceBundle.getString(key);
        if (msg == null) {
            msg = resourceBundle.getString("BadMessageKey");
            throw new MissingResourceException(msg, "org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.msg.XMLSchemaMessages", key);
        }
