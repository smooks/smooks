...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.XSNamedMap4Types;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.XSNamedMapImpl;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSAttributeGroupDefinition;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSConstants;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSElementDeclaration;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSNamedMap;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSNamespaceItem;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSNotationDeclaration;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSWildcard;
...
public class SchemaGrammar implements XSGrammar, XSNamespaceItem {
    ...
    public SchemaGrammar(SchemaGrammar grammar) {
        ...
        if (fRGCount > 0) {
            fRedefinedGroupDecls = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[grammar.fRedefinedGroupDecls.length];
    ...
    public static class BuiltinSchemaGrammar extends SchemaGrammar {
        ...
        private static final String EXTENDED_SCHEMA_FACTORY_CLASS = "org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.ExtendedSchemaDVFactoryImpl";
        ...
        public void addGlobalGroupDecl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl decl) {
            // ignore
        }
        public void addGlobalGroupDecl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl decl, String location) {
            // ignore
        }
        ...
        public void addRedefinedGroupDecl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl derived, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl base, SimpleLocator locator) {
            // ignore
        }
     ...
     */
    public final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl getGlobalGroupDecl(String declName) {
        return(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl)fGlobalGroupDecls.get(declName);
    }

    public final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl getGlobalGroupDecl(String declName, String location) {
        return(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl)fGlobalGroupDeclsExt.get(((location != null) ? location : "") + "," + declName);
    }
    ...
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[] fRedefinedGroupDecls = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[REDEFINED_GROUP_INIT_SIZE];
     ...
     */
    final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[] getRedefinedGroupDecls() {
        if (fRGCount < fRedefinedGroupDecls.length) {
    ...
    static final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[] resize(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[] oldArray, int newSize) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[] newArray = new XSGroupDecl[newSize];
        System.arraycopy(oldArray, 0, newArray, 0, Math.min(oldArray.length, newSize));
        return newArray;
    }
    ...
    public XSModel toXSModel() {
        return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelImpl(new SchemaGrammar[]{this});
    }
