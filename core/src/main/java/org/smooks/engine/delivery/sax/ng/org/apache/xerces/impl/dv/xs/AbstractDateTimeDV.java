...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.jaxp.datatype.DatatypeFactoryImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime;
...
public abstract class AbstractDateTimeDV extends TypeValidator {
	...
	public short getAllowedFacets(){
		return ( org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.XSSimpleTypeDecl.FACET_PATTERN | org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.XSSimpleTypeDecl.FACET_WHITESPACE | org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.XSSimpleTypeDecl.FACET_ENUMERATION | org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.XSSimpleTypeDecl.FACET_MAXINCLUSIVE | org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.XSSimpleTypeDecl.FACET_MININCLUSIVE | org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.XSSimpleTypeDecl.FACET_MAXEXCLUSIVE  | XSSimpleTypeDecl.FACET_MINEXCLUSIVE  );
	}//getAllowedFacets()
	...
	static final class DateTimeData implements XSDateTime {
		...
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getYear()
		 */
		public int getYears() {
            if(type instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DurationDV)
                return 0;
			return normalized?year:unNormYear;
		}
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getMonth()
		 */
		...
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getDay()
		 */
		public int getDays() {
            if(type instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DurationDV)
                return 0;
		...
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getHour()
		 */
		public int getHours() {
            if(type instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DurationDV)
                return 0;
		...
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getMinutes()
		 */
		...
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getSeconds()
		 */
		...
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#hasTimeZone()
		 */
		public boolean hasTimeZone() {
			return utc != 0;
		}
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getTimeZoneHours()
		 */
		public int getTimeZoneHours() {
			return timezoneHr;
		}
		/* (non-Javadoc)
		 * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getTimeZoneMinutes()
		 */
		public int getTimeZoneMinutes() {
			return timezoneMin;
		}
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getLexicalValue()
         */
        public String getLexicalValue() {
            return originalValue;
        }
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#normalize()
         */
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#isNormalized()
         */
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getXMLGregorianCalendar()
         */
        public XMLGregorianCalendar getXMLGregorianCalendar() {
            return type.getXMLGregorianCalendar(this);
        }
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.XSDateTime#getDuration()
         */
