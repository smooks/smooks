...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.RangeImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.events.EventImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.events.MouseEventImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.events.MutationEventImpl;
...
public class DocumentImpl
    ...
    public Range createRange() {
        ...
        Range range = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.RangeImpl(this);
    ...
    private void notifyRangesReplacedText(CharacterDataImpl node) {
        ...
        while (i.hasNext()) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.RangeImpl range = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.RangeImpl) ((Reference) i.next()).get();
            if (range != null) {
     ...
     */
    protected void setEventListeners(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl n, Vector listeners) {
     ...
     */
    protected Vector getEventListeners(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl n) {
        if (eventListeners == null) {
            return null;
        }
                                    ...
                                    EventListener listener, boolean useCapture)
    {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(type);
        if (useCapture) {
            ++lc.captures;
            ++lc.total;
        }
    ...
    */
    protected boolean dispatchEvent(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, Event event) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(evt.getType());
        if (lc.total == 0)
        ...
        if (lc.captures > 0) {
            ...
            for (int j = pv.size() - 1; j >= 0; --j) {
                ...
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl nn = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) pv.get(j);
    ...
    protected void dispatchEventToSubtree(Node n, Event e) {
        ...
        ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) n).dispatchEvent(e);
    ...
    class EnclosingAttr implements Serializable {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl node;
        String oldvalue;
    }
     ...
     */
    protected void dispatchAggregateEvents(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, EnclosingAttr ea) {
        if (ea != null)
     ...
     */
    protected void dispatchAggregateEvents(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node,
                                           org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl enclosingAttr,
                                           String oldvalue, short change) {
        // We have to send DOMAttrModified.
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl owner = null;
        if (enclosingAttr != null) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(MutationEventImpl.DOM_ATTR_MODIFIED);
            owner = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) enclosingAttr.getOwnerElement();
            if (lc.total > 0) {
                if (owner != null) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(MutationEventImpl.DOM_SUBTREE_MODIFIED);
        if (lc.total > 0) {
     ...
     */
    protected void saveEnclosingAttr(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(MutationEventImpl.DOM_ATTR_MODIFIED);
        if (lc.total > 0) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl eventAncestor = node;
            while (true) {
                ...
                if (type == Node.ATTRIBUTE_NODE) {
                    ...
                    retval.node = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) eventAncestor;
    ...
    private void mutationEventsModifiedCharacterData(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, String oldvalue, String value, boolean replace) {
        if (!replace) {
            // MUTATION POST-EVENTS:
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc =
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(MutationEventImpl.DOM_CHARACTER_DATA_MODIFIED);
            if (lc.total > 0) {
                MutationEvent me = new MutationEventImpl();
    ...
    private void mutationEventsInsertedNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl newInternal, boolean replace) {
        // MUTATION POST-EVENTS:
        // "Local" events (non-aggregated)
        // New child is told it was inserted, and where
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(MutationEventImpl.DOM_NODE_INSERTED);
        if (lc.total > 0) {
            MutationEventImpl me = new MutationEventImpl();
        ...
        // to the Doc.
        lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(
                        MutationEventImpl.DOM_NODE_INSERTED_INTO_DOCUMENT);
        if (lc.total > 0) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl eventAncestor = node;
            if (savedEnclosingAttr != null)
                eventAncestor = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)
                    savedEnclosingAttr.node.getOwnerElement();
            if (eventAncestor != null) { // Might have been orphan Attr
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl p = eventAncestor;
                while (p != null) {
                    eventAncestor = p; // Last non-null ancestor
                    // In this context, ancestry includes
                    // walking back from Attr to Element
                    if (p.getNodeType() == ATTRIBUTE_NODE) {
                        p = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)p).getOwnerElement();
                    }
                    else {
                        p = p.parentNode();
                    }
    ...
    private void notifyRangesInsertedNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl newInternal) {
        removeStaleRangeReferences();
        final Iterator i = ranges.iterator();
        while (i.hasNext()) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.RangeImpl range = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.RangeImpl) ((Reference) i.next()).get();
    ...
    private void notifyIteratorsRemovingNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl oldChild) {
        removeStaleIteratorReferences();
    ...
    private void notifyRangesRemovingNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl oldChild) {
        removeStaleRangeReferences();
        final Iterator i = ranges.iterator();
        while (i.hasNext()) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.RangeImpl range = (RangeImpl) ((Reference) i.next()).get();
            if (range != null) {
    ...
    private void mutationEventsRemovingNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl oldChild, boolean replace) {
        // MUTATION PREPROCESSING AND PRE-EVENTS:
        // If we're within the scope of an Attr and DOMAttrModified 
        // was requested, we need to preserve its previous value for
        // that event.
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount lc = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.LCount.lookup(MutationEventImpl.DOM_NODE_REMOVED);
        if (lc.total > 0) {
            MutationEventImpl me= new MutationEventImpl();
        ...
        if (lc.total > 0) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl eventAncestor = this;
            if(savedEnclosingAttr != null)
                eventAncestor = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)
                    savedEnclosingAttr.node.getOwnerElement();
            if (eventAncestor != null) { // Might have been orphan Attr
                for (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl p = eventAncestor.parentNode();
     ...
     */
    void removedAttrNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl oldOwner, String name) {
