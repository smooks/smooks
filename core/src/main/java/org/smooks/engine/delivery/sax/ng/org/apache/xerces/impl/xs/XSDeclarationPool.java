...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl;
...
public final class XSDeclarationPool {
    ...
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl fElementDecl[][] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[INITIAL_CHUNK_COUNT][];
    private int fElementDeclIndex = 0;

    /** Particle declaration pool */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl fParticleDecl[][] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl[INITIAL_CHUNK_COUNT][];
    private int fParticleDeclIndex = 0;

    /** Particle declaration pool */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl fModelGroup[][] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl[INITIAL_CHUNK_COUNT][];
    private int fModelGroupIndex = 0;

    /** Attribute declaration pool */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl fAttrDecl[][] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl[INITIAL_CHUNK_COUNT][];
    private int fAttrDeclIndex = 0;

    /** ComplexType declaration pool */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl fCTDecl[][] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl[INITIAL_CHUNK_COUNT][];
    ...
    public final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl getElementDecl(){
        int     chunk       = fElementDeclIndex >> CHUNK_SHIFT;
        int     index       = fElementDeclIndex &  CHUNK_MASK;
        ensureElementDeclCapacity(chunk);
        if (fElementDecl[chunk][index] == null) {
            fElementDecl[chunk][index] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl();
        } else {
    ...
    public final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl getAttributeDecl(){
        ...
        if (fAttrDecl[chunk][index] == null) {
            fAttrDecl[chunk][index] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl();
        } else {
    ...
    public final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl getComplexTypeDecl(){
        int     chunk       = fCTDeclIndex >> CHUNK_SHIFT;
        int     index       = fCTDeclIndex &  CHUNK_MASK;
        ensureCTDeclCapacity(chunk);
        if (fCTDecl[chunk][index] == null) {

            fCTDecl[chunk][index] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl();
        } else {
    ...
    public final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl getParticleDecl(){
        ...
        if (fParticleDecl[chunk][index] == null) {
            fParticleDecl[chunk][index] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl();
        } else {
    ...
    public final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl getModelGroup(){
        ...
        if (fModelGroup[chunk][index] == null) {
            fModelGroup[chunk][index] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl();
        } else {
    ...
    private boolean ensureElementDeclCapacity(int chunk) {
        ...
        fElementDecl[chunk] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[CHUNK_SIZE];
        return true;
    }

    private static org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[][] resize(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl array[][], int newsize) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl newarray[][] = new XSElementDecl[newsize][];
    ...
    private boolean ensureParticleDeclCapacity(int chunk) {
        ...
        fParticleDecl[chunk] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl[CHUNK_SIZE];
        return true;
    }
    ...
    private boolean ensureModelGroupCapacity(int chunk) {
        ...
        fModelGroup[chunk] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl[CHUNK_SIZE];
        return true;
    }

    private static org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl[][] resize(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl array[][], int newsize) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl newarray[][] = new XSParticleDecl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }

    private static org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl[][] resize(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl array[][], int newsize) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSModelGroupImpl newarray[][] = new XSModelGroupImpl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }
    ...
    private boolean ensureAttrDeclCapacity(int chunk) {
        ...
        fAttrDecl[chunk] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl[CHUNK_SIZE];
        return true;
    }

    private static org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl[][] resize(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl array[][], int newsize) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl newarray[][] = new XSAttributeDecl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }
    ...
    private boolean ensureCTDeclCapacity(int chunk) {
        ...
        fCTDecl[chunk] = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl[CHUNK_SIZE];
        return true;
    }

    private static org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl[][] resize(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl array[][], int newsize) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl newarray[][] = new XSComplexTypeDecl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }
