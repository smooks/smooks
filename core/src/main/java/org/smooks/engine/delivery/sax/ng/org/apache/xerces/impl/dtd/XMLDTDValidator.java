...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.*;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammar;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLDTDLoader;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLEntityDecl;
...
public class XMLDTDValidator
    ...
    /** DTD Grammar. */
    protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammar fDTDGrammar;
    ...
    private final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl fTempElementDecl = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl();
    ...
    private final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLEntityDecl fEntityDecl = new XMLEntityDecl();
    ...
    throws XNIException {
        ...
        if (fGrammarPool != null) {
            ...
            for (int i = 0; i < length; ++i) {
                fGrammarBucket.putGrammar((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammar)grammars[i]);
            }
        }
    ...
    throws XNIException {
        ...
        if(fDTDGrammar == null) {
            ...
            if (fGrammarPool != null && (systemId != null || publicId != null)) {
                fDTDGrammar = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammar)fGrammarPool.retrieveGrammar(grammarDesc);
            }
        }
        if(fDTDGrammar == null) {
    ...
    public void characters(XMLString text, Augmentations augs) throws XNIException {
        ...
        if (fPerformValidation) {
            ...
            if (fCurrentContentSpecType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_EMPTY) {
                charDataInContent();
            }
        }
    ...
    public void comment(XMLString text, Augmentations augs) throws XNIException {
        ...
        if (fPerformValidation && fElementDepth >= 0 && fDTDGrammar != null) {
            ...
            if (fTempElementDecl.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_EMPTY) {
                    fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, 
                                               "MSG_CONTENT_INVALID_SPECIFIED",
                                               new Object[]{ fCurrentElement.rawname,
                                                             "EMPTY",
    ...
    throws XNIException {
        ...
        while (attlistIndex != -1) {
            ...
            if (DEBUG_ATTRIBUTES) {
                if (fTempAttDecl != null) {
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl elementDecl = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl();
            ...
            boolean required = attDefaultType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.DEFAULT_TYPE_REQUIRED;
        ...
        for (int i = 0; i < attrCount; i++) {
            ...
            if (fTempAttDecl.simpleType.defaultType ==
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.DEFAULT_TYPE_FIXED) {
            ...
            if (fTempAttDecl.simpleType.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_ENTITY ||
                fTempAttDecl.simpleType.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_ENUMERATION ||
                fTempAttDecl.simpleType.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_ID ||
                fTempAttDecl.simpleType.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_IDREF ||
                fTempAttDecl.simpleType.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_NMTOKEN ||
                fTempAttDecl.simpleType.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_NOTATION
               ) {
    ...
    throws XNIException {
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_ENTITY: {                            
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_NOTATION:
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_ENUMERATION: {
                boolean found = false;
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_ID: {
                try {
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_IDREF: {
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLSimpleType.TYPE_NMTOKEN: {
                boolean isAlistAttribute = attributeDecl.simpleType.list;//Caveat - Save this information because invalidStandaloneAttDef
                //changes fTempAttDef
                try {
                    if (isAlistAttribute) {
    ...
    private int checkContent(int elementIndex, 
        ...
        //  full DFA treatment.
        //
        if (contentType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_EMPTY) {
            //
        ...
        else if (contentType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_ANY) {
            //
            //  This one is open game so we don't pass any judgement on it
            //  at all. Its assumed to fine since it can hold anything.
            //
        }
        else if (contentType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_MIXED ||  
                 contentType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_CHILDREN) {
        ...
        else if (contentType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_SIMPLE) {
    ...
    protected boolean handleStartElement(QName element, XMLAttributes attributes, Augmentations augs) 
        ...
        fInElementContent = fCurrentContentSpecType == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_CHILDREN;
