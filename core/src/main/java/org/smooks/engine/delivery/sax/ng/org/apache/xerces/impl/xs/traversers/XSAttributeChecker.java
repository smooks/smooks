...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.XIntPool;
...
public class XSAttributeChecker {
     ...
     */
    public Object[] checkAttributes(Element element, boolean isGlobal,
                                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDocumentInfo schemaDoc, boolean enumAsQName) {
        if (element == null)
            return null;
    ...
    private Object validate(Object[] attrValues, String attr, String ivalue, int dvIndex,
                            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDocumentInfo schemaDoc) throws InvalidDatatypeValueException {
        if (ivalue == null)
            return null;
    ...
    public void returnAttrArray(Object[] attrArray, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDocumentInfo schemaDoc) {
