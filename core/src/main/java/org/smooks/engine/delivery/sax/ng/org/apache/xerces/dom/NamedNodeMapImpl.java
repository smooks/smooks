...
public class NamedNodeMapImpl
    ...
    protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl ownerNode; // the node this map belongs to
    ...
    protected NamedNodeMapImpl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl ownerNode) {
    ...
    throws DOMException {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CoreDocumentImpl ownerDocument = ownerNode.ownerDocument();
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl previous = null;
        if (i >= 0) {
            previous = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) nodes.get(i);
            nodes.set(i, arg);
        } else {
    ...
    public Node removeNamedItem(String name)
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl n = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)nodes.get(i);
        nodes.remove(i);
        ...
        if (srcnodes != null) {
            ...
            if (size != 0) {
                ...
                for (int i = 0; i < size; ++i) {
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl n = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) srcmap.nodes.get(i);
    ...
    void setReadOnly(boolean readOnly, boolean deep) {
    	...
    	if (deep && nodes != null) {
            for (int i = nodes.size() - 1; i >= 0; i--) {
                ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) nodes.get(i)).setReadOnly(readOnly,deep);
            }
    	}
    ...
    protected void setOwnerDocument(CoreDocumentImpl doc) {
        if (nodes != null) {
            ...
            for (int i = 0; i < size; ++i) {
                ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)item(i)).setOwnerDocument(doc);
            }
        }
    }
    ...
    protected int findNamePoint(String namespaceURI, String name) {
        ...
        final int size = nodes.size();
        for (int i = 0; i < size; ++i) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl a = (NodeImpl)nodes.get(i);
