...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.DVFactoryException;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.ObjectFactory;
...
public abstract class SchemaDVFactory {
    ...
    private static final String DEFAULT_FACTORY_CLASS = "org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.SchemaDVFactoryImpl";
    ...
    public static final SchemaDVFactory getInstance(String factoryClass) throws DVFactoryException {
        try {
            ...
            return (SchemaDVFactory)(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.ObjectFactory.newInstance(
                factoryClass, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.ObjectFactory.findClassLoader(), true));
        } 
     ...
     */
    public abstract org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType getBuiltInType(String name);
     ...
     */
    public abstract org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType createTypeRestriction(String name, String targetNamespace,
                                                                                 short finalSet, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType base,
     ...
     * @return                  the newly created simple type
     */
    public abstract org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType createTypeList(String name, String targetNamespace,
                                                                          short finalSet, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType itemType,
                                                                          XSObjectList annotations);
     ...
     * @return                  the newly created simple type
     */
    public abstract org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType createTypeUnion(String name, String targetNamespace,
