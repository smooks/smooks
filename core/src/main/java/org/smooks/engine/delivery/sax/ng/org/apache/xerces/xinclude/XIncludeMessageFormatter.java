...
public class XIncludeMessageFormatter implements MessageFormatter {
    ...
    public String formatMessage(Locale locale, String key, Object[] arguments)
        ...
        if (locale != fLocale) {
            fResourceBundle = ResourceBundle.getBundle("org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.msg.XIncludeMessages", locale);
        ...
        if (msg == null) {
            ...
            throw new MissingResourceException(msg, "org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.msg.XIncludeMessages", key);
        }
