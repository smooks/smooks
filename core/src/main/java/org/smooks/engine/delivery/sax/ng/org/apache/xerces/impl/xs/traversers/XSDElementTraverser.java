...
class XSDElementTraverser extends XSDAbstractTraverser {
    ...
    XSDElementTraverser (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler handler,
    ...
    protected void traverseLocal(XSParticleDecl particle,
        ...
        QName refAtt = (QName) attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_REF];
        XInt  minAtt = (XInt)  attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_MINOCCURS];
        XInt  maxAtt = (XInt)  attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_MAXOCCURS];
        
        XSElementDecl element = null;
        XSAnnotationImpl annotation = null;
        if (elmDecl.getAttributeNode(SchemaSymbols.ATT_REF) != null) {
            if (refAtt != null) {
                element = (XSElementDecl)fSchemaHandler.getGlobalDecl(schemaDoc, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler.ELEMENT_TYPE, refAtt, elmDecl);
        ...
        Long defaultVals = (Long)attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_FROMDEFAULT];
    ...
    XSElementDecl traverseNamedElement(Element elmDecl,
        ...
        Boolean abstractAtt  = (Boolean) attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_ABSTRACT];
        XInt    blockAtt     = (XInt)    attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_BLOCK];
        String  defaultAtt   = (String)  attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_DEFAULT];
        XInt    finalAtt     = (XInt)    attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_FINAL];
        String  fixedAtt     = (String)  attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_FIXED];
        XInt    formAtt      = (XInt)    attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_FORM];
        String  nameAtt      = (String)  attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAME];
        Boolean nillableAtt  = (Boolean) attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_NILLABLE];
        QName   subGroupAtt  = (QName)   attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_SUBSGROUP];
        ...
        if (subGroupAtt != null) {
            element.fSubGroup = (XSElementDecl)fSchemaHandler.getGlobalDecl(schemaDoc, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler.ELEMENT_TYPE, subGroupAtt, elmDecl);
        }
        ...
        if (elementType == null && typeAtt != null) {
            elementType = (XSTypeDefinition)fSchemaHandler.getGlobalDecl(schemaDoc, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler.TYPEDECL_TYPE, typeAtt, elmDecl);
            if (elementType == null) {
