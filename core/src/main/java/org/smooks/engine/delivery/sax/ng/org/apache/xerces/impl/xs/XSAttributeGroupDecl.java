...
public class XSAttributeGroupDecl implements XSAttributeGroupDefinition {
    ...
    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl[] fAttributeUses = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl[INITIAL_SIZE];
    ...
    public String addAttributeUse(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl attrUse) {

        // if this attribute use is prohibited, then don't check whether it's
        // of type ID
        if (attrUse.fUse != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.USE_PROHIBITED) {
    ...
    public void replaceAttributeUse(XSAttributeUse oldUse, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl newUse) {
    ...
    public XSAttributeUse getAttributeUseNoProhibited(String namespace, String name) {
        for (int i=0; i<fAttrUseNum; i++) {
            if ( (fAttributeUses[i].fAttrDecl.fTargetNamespace == namespace) &&
                 (fAttributeUses[i].fAttrDecl.fName == name) &&
                 (fAttributeUses[i].fUse != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.USE_PROHIBITED))
                return fAttributeUses[i];
        }
    ...
    public void removeProhibitedAttrs() {
        ...
        int count = 0;
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl[] uses = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl[fAttrUseNum];
        for (int i = 0; i < fAttrUseNum; i++) {
            if (fAttributeUses[i].fUse != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.USE_PROHIBITED) {
...
//        }
    ...
    public Object[] validRestrictionOf(String typeName, XSAttributeGroupDecl baseGroup) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl attrUse = null;
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeDecl attrDecl = null;
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl baseAttrUse = null;
        ...
        for (int i=0; i<fAttrUseNum; i++) {
            ...
            baseAttrUse = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl)baseGroup.getAttributeUse(attrDecl.fTargetNamespace,attrDecl.fName);
            if (baseAttrUse != null) {
                //
                ...
                if (baseAttrUse.getRequired() && !attrUse.getRequired()) {
                    errorArgs = new Object[]{typeName, attrDecl.fName,
                    	                     attrUse.fUse == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.USE_OPTIONAL ? org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_OPTIONAL : org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_PROHIBITED,
    ...
    static final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl[] resize(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl[] oldArray, int newSize) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSAttributeUseImpl[] newArray = new XSAttributeUseImpl[newSize];
