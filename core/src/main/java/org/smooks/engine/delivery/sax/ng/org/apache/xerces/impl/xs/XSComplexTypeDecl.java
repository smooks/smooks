...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSComplexTypeDefinition;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSParticle;
...
public class XSComplexTypeDecl implements XSComplexTypeDefinition, TypeInfo {
    ...
    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSParticleDecl fParticle = null;
   ...
   public void setName(String name) {
    ...
    public boolean derivedFromType(XSTypeDefinition ancestor, short derivationMethod) {
        ...
        if (ancestor == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType)
            return true;
        // recursively get base, and compare it with ancestor
        XSTypeDefinition type = this;
        while (type != ancestor &&                     // compare with ancestor
               type != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnySimpleType &&  // reached anySimpleType
               type != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType) {        // reached anyType
    ...
    public boolean derivedFrom(String ancestorNS, String ancestorName, short derivationMethod) {
        ...
        // ancestor is anyType, return true
        if (ancestorNS != null &&
            ancestorNS.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA) &&
            ancestorName.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE)) {
            return true;
        }
        ...
        return type != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnySimpleType &&
    ...
    public boolean isDOMDerivedFrom(String ancestorNS, String ancestorName,
        ...
        if ((((derivationMethod & DERIVATION_LIST) != 0) || ((derivationMethod & DERIVATION_UNION) != 0))
            ...
            if (ancestorNS.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA)
                    && ancestorName.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE)) {
                ancestorName = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_ANYSIMPLETYPE;
            }

            if(!(fName.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE) 
                            && fTargetNamespace.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA))){
    ...
    private boolean isDerivedByRestriction(String ancestorNS,
        ...
        while (type != null && type != oldType) {
            ...
            if (ancestorNS != null
                    && ancestorNS.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA)
                    && ancestorName.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_ANYSIMPLETYPE)) {
                return false;
            }
    ...
    private boolean isDerivedByExtension(String ancestorNS,
        ...
        while (type != null && type != oldType) {
            ...
            if (ancestorNS != null
                    && ancestorNS.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA)
                    && ancestorName.equals(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_ANYSIMPLETYPE)
                    && org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA.equals(type.getNamespace())
                            && org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE.equals(type.getName())) {
                break;
            }
    ...
    /* (non-Javadoc)
     * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSComplexTypeDefinition#getAttributeUse(java.lang.String, java.lang.String)
     */
