...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammarBucket;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xni.parser.XMLDTDContentModelFilter;
...
public class XMLDTDProcessor
    ...
    private final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLEntityDecl fEntityDecl = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLEntityDecl();
     ...
     */
    protected static void checkStandaloneEntityRef(String name, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammar grammar,
    ...
    public void attributeDecl(String elementName, String attributeName, 
        ...
        if (fValidation) {
                ...
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammar grammar = (fDTDGrammar != null? fDTDGrammar:fGrammarBucket.getActiveGrammar());
    ...
    public void endDTD(Augmentations augs) throws XNIException {
        ...
        if (fValidation) {
            ...
            while (elementsWithNotations.hasNext()) {
                ...
                int elementIndex = grammar.getElementDeclIndex(elementName);
                if (grammar.getContentSpecType(elementIndex) == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_EMPTY) {
                    String attributeName = (String) entry.getValue();
                    fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN,
     ...
     */
    private void checkDeclaredElements(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.DTDGrammar grammar) {
        int elementIndex = grammar.getFirstElementDeclIndex();
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec contentSpec = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec();
        while (elementIndex >= 0) {
            int type = grammar.getContentSpecType(elementIndex);
            if (type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLElementDecl.TYPE_CHILDREN || type == XMLElementDecl.TYPE_MIXED) {
                checkDeclaredElements(grammar, 
                        elementIndex, 
    ...
    private void checkDeclaredElements(DTDGrammar grammar, int elementIndex,
                                       int contentSpecIndex, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec contentSpec) {
        grammar.getContentSpec(contentSpecIndex, contentSpec);
        if (contentSpec.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec.CONTENTSPECNODE_LEAF) {
        ...
        else if ((contentSpec.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec.CONTENTSPECNODE_CHOICE)
                || (contentSpec.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec.CONTENTSPECNODE_SEQ)) {
        ...
        else if (contentSpec.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec.CONTENTSPECNODE_ZERO_OR_MORE
                || contentSpec.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.XMLContentSpec.CONTENTSPECNODE_ZERO_OR_ONE
