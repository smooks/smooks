...
public class DOMUtil {
    ...
    public static void setHidden(Node node) {
        if (node instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl)
            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl)node).setReadOnly(true, false);
        else if (node instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)
            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)node).setReadOnly(true, false);
    } // setHidden(node):void
    ...
    public static void setVisible(Node node) {
        if (node instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl)
            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl)node).setReadOnly(false, false);
        else if (node instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)
            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)node).setReadOnly(false, false);
    ...
    public static boolean isHidden(Node node) {
        if (node instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl)
            return ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.NodeImpl)node).getReadOnly();
        else if (node instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)
            return ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)node).getReadOnly();
        return false;
