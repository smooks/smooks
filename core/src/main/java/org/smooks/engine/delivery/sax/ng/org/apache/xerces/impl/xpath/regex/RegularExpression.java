...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.*;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.BMPattern;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RangeToken;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RegexParser;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.IntStack;
 ...
 * after <code><a href="#matches(java.lang.String, org.smooks.engine.delivery.sax.ng.org.apache.xerces.utils.regex.Match)">matches(String,Match)</a></code>.
...
public class RegularExpression implements java.io.Serializable {
     ...
     */
    private synchronized void compile(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token tok) {
     ...
     */
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op compile(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token tok, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op next, boolean reverse) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op ret;
        switch (tok.type) {
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.DOT:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createDot();
            ret.next = next;
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.CHAR:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createChar(tok.getChar());
            ret.next = next;
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.ANCHOR:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createAnchor(tok.getChar());
            ret.next = next;
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.RANGE:
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.NRANGE:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createRange(tok);
            ret.next = next;
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.CONCAT:
            ret = next;
            if (!reverse) {
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.UNION:
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.UnionOp uni = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createUnion(tok.size());
            for (int i = 0;  i < tok.size();  i ++) {
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.CLOSURE:
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.NONGREEDYCLOSURE:
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token child = tok.getChild(0);
            int min = tok.getMin();
            int max = tok.getMax();
            if (min >= 0 && min == max) { // {n}
                ret = next;
            ...
            if (max > 0) {
                ...
                ret = next;
                for (int i = 0;  i < max;  i ++) {
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.ChildOp q = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createQuestion(tok.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.NONGREEDYCLOSURE);
                    q.next = next;
                    q.setChild(compile(child, ret, reverse));
                    ret = q;
                }
            } else {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.ChildOp op;
                if (tok.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.NONGREEDYCLOSURE) {
                    op = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createNonGreedyClosure();
                } else {                        // Token.CLOSURE
                    op = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createClosure(this.numberOfClosures++);
                }
                op.next = next;
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.EMPTY:
            ret = next;
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.STRING:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createString(tok.getString());
            ret.next = next;
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.BACKREFERENCE:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createBackReference(tok.getReferenceNumber());
            ret.next = next;
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.PAREN:
            if (tok.getParenNumber() == 0) {
                ret = compile(tok.getChild(0), next, reverse);
            } else if (reverse) {
                next = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createCapture(tok.getParenNumber(), next);
                next = compile(tok.getChild(0), next, reverse);
                ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createCapture(-tok.getParenNumber(), next);
            } else {
                next = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createCapture(-tok.getParenNumber(), next);
                next = compile(tok.getChild(0), next, reverse);
                ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createCapture(tok.getParenNumber(), next);
        ...
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.LOOKAHEAD:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createLook(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.LOOKAHEAD, next, compile(tok.getChild(0), null, false));
            break;
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.NEGATIVELOOKAHEAD:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createLook(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NEGATIVELOOKAHEAD, next, compile(tok.getChild(0), null, false));
            break;
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.LOOKBEHIND:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createLook(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.LOOKBEHIND, next, compile(tok.getChild(0), null, true));
            break;
        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.NEGATIVELOOKBEHIND:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createLook(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NEGATIVELOOKBEHIND, next, compile(tok.getChild(0), null, true));
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.INDEPENDENT:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createIndependent(next, compile(tok.getChild(0), null, reverse));
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.MODIFIERGROUP:
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createModifier(next, compile(tok.getChild(0), null, reverse),
                                    ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.ModifierToken)tok).getOptions(),
                                    ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.ModifierToken)tok).getOptionsMask());
            break;

        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.CONDITION:
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.ConditionToken ctok = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.ConditionToken)tok;
            int ref = ctok.refNumber;
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op condition = ctok.condition == null ? null : compile(ctok.condition, null, reverse);
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op yes = compile(ctok.yes, next, reverse);
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op no = ctok.no == null ? null : compile(ctok.no, next, reverse);
            ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.createCondition(next, ref, condition, yes, no);
            break;
...
//Public
    ...
    public boolean matches(char[]  target) {
        return this.matches(target, 0,  target .length , (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match)null);
    }
    ...
    public boolean matches(char[]  target, int start, int end) {
        return this.matches(target, start, end, (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match)null);
    }
     ...
     */
    public boolean matches(char[]  target, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match match) {
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(char[] target, int start, int end, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match match) {
        ...
        if (match != null) {
            ...
            match = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match();
            match.setNumberOfGroups(this.nofparen);
         ...
         */
        if (this.operations != null
            && this.operations.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.CLOSURE && this.operations.getChild().type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.DOT) {
         ...
         */
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RangeToken range = this.firstChar;
            for (matchStart = con.start;  matchStart <= limit;  matchStart ++) {
                int ch =  target [matchStart] ;
                if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.isHighSurrogate(ch) && matchStart+1 < con.limit) {
                    ch = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target[matchStart+1]);
                }
                if (!range.match(ch))  {
                    continue;
                }
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(String  target, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match match) {
        return this.matches(target, 0,  target .length() , match);
    }
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(String  target, int start, int end, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match match) {
         ...
         */
            ...
            for (matchStart = con.start;  matchStart <= limit;  matchStart ++) {
                int ch =  target .charAt(  matchStart ) ;
                if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.isHighSurrogate(ch) && matchStart+1 < con.limit) {
                    ch = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.charAt(matchStart+1));
                }
                if (!range.match(ch)) {
                    continue;
                }
     ...
     */
    private int match(Context con, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op op, int offset, int dx, int opts) {
        ...
        for (;;) {
            if (op == null || offset > con.limit || offset < con.start) {
                ...
                switch (op.type) {
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.CHAR:
                    {
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.DOT:
                    {
                        ...
                        if (isSet(opts, SINGLE_LINE)) {
                            if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.isHighSurrogate(target.charAt(o1)) && o1+dx >= 0 && o1+dx < con.limit) {
                                o1 += dx;
                            }
                        }
                        else {
                            int ch = target.charAt(o1);
                            if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.isHighSurrogate(ch) && o1+dx >= 0 && o1+dx < con.limit) {
                                o1 += dx;
                                ch = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.charAt(o1));
                            }
                            if (isEOLChar(ch)) {
                                returned = true;
                                break;
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.RANGE:
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NRANGE:
                    {
                        int o1 = (dx > 0) ? offset : offset -1;
                        if (o1 >= con.limit || o1 < 0) {
                            returned = true;
                        ...
                        if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.isHighSurrogate(ch) && o1+dx < con.limit && o1+dx >=0) {
                            o1 += dx;
                            ch = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.charAt(o1));
                        }
                        final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RangeToken tok = op.getToken();
                        if (!tok.match(ch)) {
                            returned = true;
                            break;
                        }
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.ANCHOR:
                    {
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.BACKREFERENCE:
                    {
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.STRING:
                    {
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.CLOSURE:
                    {
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.QUESTION:
                    {
                        opStack.push(op);
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NONGREEDYCLOSURE:
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NONGREEDYQUESTION:
                    {
                        opStack.push(op);
                        dataStack.push(offset);
                        op = op.next;
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.UNION:
                    if (op.size() == 0) {
                        returned = true;
                    }
                    else {
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.CAPTURE:
                    {
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.LOOKAHEAD:
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NEGATIVELOOKAHEAD:
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.LOOKBEHIND:
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NEGATIVELOOKBEHIND:
                    {
                        opStack.push(op);
                        dataStack.push(dx);
                        dataStack.push(offset);
                        dx = (op.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.LOOKAHEAD || op.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.NEGATIVELOOKAHEAD) ? 1 : -1;
                        op = op.getChild();
                    }
                    break;

                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.INDEPENDENT:
                    {
                        opStack.push(op);
                        dataStack.push(offset);
                        op = op.getChild();
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.MODIFIER:
                    {
                        int localopts = opts;
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.CONDITION:
                    {
                        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.ConditionOp cop = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.ConditionOp)op;
                        if (cop.refNumber > 0) {
            ...
            while (returned) {
                ...
                op = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op) opStack.pop();
                ...
                case org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.CONDITION:
                    {
                        final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.ConditionOp cop = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.ConditionOp)op;
                        if (0 <= retValue) {
                            op = cop.yes;
                        }
                        else if (cop.no != null) {
    ...
    boolean matchAnchor(ExpressionTarget target, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op op, Context con, int offset, int opts) {
        boolean go = false;
        switch (op.getData()) {
        case '^':
    ...
    public boolean matches(CharacterIterator target) {
        return this.matches(target, (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match)null);
    }
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(CharacterIterator  target, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match match) {
         ...
         */
            ...
            for (matchStart = con.start;  matchStart <= limit;  matchStart ++) {
                int ch =  target .setIndex(  matchStart ) ;
                if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.isHighSurrogate(ch) && matchStart+1 < con.limit) {
                    ch = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.setIndex(matchStart+1));
                }
                if (!range.match(ch)) {
                    continue;
                }
    ...
    transient org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op operations = null;
    transient int numberOfClosures;
    transient Context context = null;
    transient org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RangeToken firstChar = null;

    transient String fixedString = null;
    transient int fixedStringOptions;
    transient org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.BMPattern fixedStringTable = null;
     ...
     */
    void prepare() {
        if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.COUNT)  org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.nofinstances = 0;
        ...
        */
        if (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.COUNT)  System.err.println("DEBUG: The number of operations: "+ org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.nofinstances);
        ...
        if (!isSet(this.options, PROHIBIT_HEAD_CHARACTER_OPTIMIZATION)
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RangeToken firstChar = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.createRange();
            int fresult = this.tokentree.analyzeFirstCharacter(firstChar, this.options);
            if (fresult == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.FC_TERMINAL) {
        ...
        if (this.operations != null
            && (this.operations.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.STRING || this.operations.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.CHAR)
            && this.operations.next == null) {
            if (DEBUG)
                System.err.print(" *** Only fixed string! *** ");
            this.fixedStringOnly = true;
            if (this.operations.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Op.STRING)
                this.fixedString = this.operations.getString();
            else if (this.operations.getData() >= 0x10000) { // Op.CHAR
                this.fixedString = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.decomposeToSurrogates(this.operations.getData());
            } else {
                char[] ac = new char[1];
            ...
            this.fixedStringTable = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.BMPattern(this.fixedString, 256,
                                                  isSet(this.fixedStringOptions, IGNORE_CASE));
        } else if (!isSet(this.options, PROHIBIT_FIXED_STRING_OPTIMIZATION)
                   && !isSet(this.options, XMLSCHEMA_MODE)) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.FixedStringContainer container = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.FixedStringContainer();
            ...
            if (this.fixedString != null) {
                ...
                if (DEBUG) {
                    System.err.println("DEBUG: The longest fixed string: "+this.fixedString.length()
                                       +"/" //+this.fixedString
                                       +"/"+ org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.createOptionString(this.fixedStringOptions));
                    System.err.print("String: ");
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.dumpString(this.fixedString);
                }
            }
        }
    }
     ...
     * @exception org.smooks.engine.delivery.sax.ng.org.apache.xerces.utils.regex.ParseException <VAR>regex</VAR> is not conforming to the syntax.
     */
    public RegularExpression(String regex) throws org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException {
        this(regex, null);
    }
     ...
     * @exception org.smooks.engine.delivery.sax.ng.org.apache.xerces.utils.regex.ParseException <VAR>regex</VAR> is not conforming to the syntax.
     */
    public RegularExpression(String regex, String options) throws org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException {
     ...
     * @exception org.smooks.engine.delivery.sax.ng.org.apache.xerces.utils.regex.ParseException <VAR>regex</VAR> is not conforming to the syntax.
     */
    public RegularExpression(String regex, String options, Locale locale) throws org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException {
        this.setPattern(regex, options, locale);
    }

    RegularExpression(String regex, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token tok, int parens, boolean hasBackReferences, int options) {
        this.regex = regex;
        this.tokentree = tok;
     ...
     *
     */
    public void setPattern(String newPattern) throws org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException {
        this.setPattern(newPattern, Locale.getDefault());
    }
    
    public void setPattern(String newPattern, Locale locale) throws org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException {
        this.setPattern(newPattern, this.options, locale);
    }

    private void setPattern(String newPattern, int options, Locale locale) throws org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException {
        this.regex = newPattern;
        this.options = options;
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RegexParser rp = RegularExpression.isSet(this.options, RegularExpression.XMLSCHEMA_MODE)
                         ? new ParserForXMLSchema(locale) : new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.RegexParser(locale);
     ...
     *
     */
    public void setPattern(String newPattern, String options) throws org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.ParseException {
    ...
    public void setPattern(String newPattern, String options, Locale locale) throws ParseException {
        this.setPattern(newPattern, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.REUtil.parseOptions(options), locale);
    }
    ...
    private static final int getWordType0(char ch, int opts) {
        if (!isSet(opts, UNICODE_WORD_BOUNDARY)) {
            if (isSet(opts, USE_UNICODE_CATEGORY)) {
                return (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.getRange("IsWord", true).match(ch)) ? WT_LETTER : WT_OTHER;
            }
