...
public abstract class NodeImpl
    ...
    public Node cloneNode(boolean deep) {
        ...
        callUserDataHandlers(this, newnode,
    ...
    public short compareTreePosition(Node other) {
        ...
        if (thisAncestorType == Node.ATTRIBUTE_NODE)  {
           thisNode = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)thisAncestor).getOwnerElement();
        }
        if (otherAncestorType == Node.ATTRIBUTE_NODE) {
           otherNode = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)otherAncestor).getOwnerElement();
        }
