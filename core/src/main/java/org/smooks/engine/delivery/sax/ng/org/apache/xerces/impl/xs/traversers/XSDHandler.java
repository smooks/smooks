...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.SchemaParsingConfig;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.*;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.SimpleLocator;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.XSInputSource;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xni.grammars.XMLSchemaDescription;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSTerm;
...
public class XSDHandler {
    ...
    private String doc2SystemId(Element ele) {
         ...
         */
        if(ele.getOwnerDocument() instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.SchemaDOM){
            documentURI = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.opti.SchemaDOM) ele.getOwnerDocument()).getDocumentURI();
        }
