...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.models.*;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.models.XSAllCM;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.models.XSCMLeaf;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.models.XSDFACM;
...
public class CMBuilder {
    ...
    XSCMValidator createAllCM(XSParticleDecl particle) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.models.XSAllCM allContent = new XSAllCM(particle.fMinOccurs == 0, group.fParticleCount);
    ...
    private CMNode copyNode(CMNode node) {
        ...
        // with a distinct position
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.models.XSCMLeaf leaf = (XSCMLeaf)node;
