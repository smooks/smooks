...
public class XSParticleDecl implements XSParticle {
    ...
    public int maxEffectiveTotalRange() {
        ...
        if (fType == PARTICLE_MODELGROUP) {
            ...
            if (max == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED)
                return org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED;
            if (max != 0 && fMaxOccurs == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED)
                return org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED;
    ...
    public String toString() {
        if (fDescription == null) {
            ...
            if (!(fMinOccurs == 0 && fMaxOccurs == 0 ||
                ...
                if (fMaxOccurs == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED)
