...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredElementNSImpl;
...
public class DeferredElementImpl
    ...
    protected final void synchronizeData() {
        ...
        if (index != -1) {
            ...
            do {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl attr = (NodeImpl)ownerDocument.getNodeObject(index);
