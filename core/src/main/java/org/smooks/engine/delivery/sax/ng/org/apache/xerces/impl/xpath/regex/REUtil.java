...
public final class REUtil {
    ...
    /**
     * Sample entry.
     * <div>Usage: <KBD>org.smooks.engine.delivery.sax.ng.org.apache.xerces.utils.regex.REUtil &lt;regex&gt; &lt;string&gt;</KBD></div>
     */
    public static void main(String[] argv) {
        ...
        try {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Match match = new Match();
            ...
            if (pattern == null) {
                ...
                System.err.println("org.smooks.engine.delivery.sax.ng.org.apache.xerces.utils.regex.ParseException: "+pe.getMessage());
                String indent = "        ";
