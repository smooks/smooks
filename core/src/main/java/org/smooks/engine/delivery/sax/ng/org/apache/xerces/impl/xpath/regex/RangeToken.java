 ...
 * @version $Id$
 */
final class RangeToken extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token implements java.io.Serializable {
    ...
    protected void mergeRanges(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token token) {
    ...
    protected void subtractRanges(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token token) {
     ...
     */
    protected void intersectRanges(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token token) {
        RangeToken tok = (RangeToken)token;
        if (tok.ranges == null || this.ranges == null)
            return;
        this.icaseCache = null;
     ...
     */
    static org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token complementRanges(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token token) {
        ...
        if (last == UTF16_MAX)
            len -= 2;
        RangeToken ret = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.createRange();
    ...
    synchronized RangeToken getCaseInsensitiveToken() {
        ...
        RangeToken uppers = this.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.RANGE ? org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.createRange() : org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.createNRange();
        ...
        RangeToken lowers = this.type == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.RANGE ? org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.createRange() : org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.createNRange();
    ...
    public String toString(int options) {
        String ret;
        if (this.type == RANGE) {
            if (this == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.token_dot)
                ret = ".";
            else if (this == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.token_0to9)
                ret = "\\d";
            else if (this == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.token_wordchars)
                ret = "\\w";
            else if (this == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.token_spaces)
                ret = "\\s";
            else {
            ...
            if (this == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.token_not_0to9)
                ret = "\\D";
            else if (this == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.token_not_wordchars)
                ret = "\\W";
            else if (this == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xpath.regex.Token.token_not_spaces)
                ret = "\\S";
            else {
                StringBuffer sb = new StringBuffer();
                sb.append("[^");
