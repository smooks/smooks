...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementDefinitionImpl;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.EntityReferenceImpl;
...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
    ...
    protected void setDocumentClassName (String documentClassName) {
        ...
        if (!documentClassName.equals(DEFAULT_DOCUMENT_CLASS_NAME) &&
            ...
            try {
                Class _class = org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.ObjectFactory.findProviderClass (documentClassName,
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.ObjectFactory.findClassLoader (), true);
    ...
    throws XNIException {
        ...
        if (!fDeferNodeExpansion) {
            if (fDocumentClassName.equals (DEFAULT_DOCUMENT_CLASS_NAME)) {
                ...
                try {
                    ClassLoader cl = org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.ObjectFactory.findClassLoader();
                    Class documentClass = org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.ObjectFactory.findProviderClass (fDocumentClassName,
                        cl, true);
                    fDocument = (Document)documentClass.newInstance ();

                    // if subclass of our own class that's cool too
                    Class defaultDocClass =
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.ObjectFactory.findProviderClass (CORE_DOCUMENT_CLASS_NAME,
                        cl, true);
                    if (defaultDocClass.isAssignableFrom (documentClass)) {
                        fDocumentImpl = (CoreDocumentImpl)fDocument;

                        Class psviDocClass = org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.ObjectFactory.findProviderClass (PSVI_DOCUMENT_CLASS_NAME,
                            cl, true);
