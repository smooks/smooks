...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDeclHelper;
...
public class SubstitutionGroupHandler {
    ...
    private static final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[] EMPTY_GROUP = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[0];

    // global element declaration resolver
    private final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDeclHelper fXSElementDeclHelper;
    ...
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl getMatchingElemDecl(QName element, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl exemplar) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl eDecl = fXSElementDeclHelper.getGlobalElementDecl(element);
        if (eDecl == null) {
            return null;
        }
    ...
    protected boolean substitutionGroupOK(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl element, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl exemplar, short blockingConstraint) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl subGroup = element.fSubGroup;
    ...
    private boolean typeDerivationOK(XSTypeDefinition derived, XSTypeDefinition base, short blockingConstraint) {
        ...
        while (type != base && type != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType) {
            if (type.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
                devMethod |= ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl)type).fDerivedBy;
            }
            else {
            ...
            if (type == null) {
                type = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType;
            }
            if (type.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
                blockConstraint |= ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl)type).fBlock;
            }
        }
        if (type != base) {
    ...
    public boolean inSubstitutionGroup(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl element, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl exemplar) {
     ...
     */
    public void addSubstitutionGroup(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[] elements) {
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl subHead, element;
        Vector subGroup;
     ...
     */
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[] getSubstitutionGroup(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl element) {
        // If we already have sub group for this element, just return it.
        Object subGroup = fSubGroups.get(element);
        if (subGroup != null)
            return (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[])subGroup;
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[] ret = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[len];
        ...
        if (rlen < len) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[] ret1 = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl[rlen];
    ...
    private OneSubGroup[] getSubGroupB(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl element, OneSubGroup methods) {
        ...
        for (int i = group.size()-1, j; i >= 0; i--) {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl sub = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl)group.elementAt(i);
    ...
    private boolean getDBMethods(XSTypeDefinition typed, XSTypeDefinition typeb,
        ...
        while (typed != typeb && typed != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType) {
            if (typed.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE)
                dMethod |= ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSComplexTypeDecl)typed).fDerivedBy;
            else
    ...
    private static final class OneSubGroup {
        OneSubGroup() {}
        OneSubGroup(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSElementDecl sub, short dMethod, short bMethod) {
            this.sub = sub;
