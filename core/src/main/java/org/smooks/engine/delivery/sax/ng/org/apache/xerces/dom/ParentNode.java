...
public abstract class ParentNode
    extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode {
    ...
    /** First child. */
    protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode firstChild = null;
    ...
    public Node cloneNode(boolean deep) {
    	...
    	if (deep) {
            for (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode child = firstChild;
                 child != null;
    ...
    final org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode lastChild() {
        // last child is stored as the previous sibling of first child
        return firstChild != null ? firstChild.previousSibling : null;
    }

    final void lastChild(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode node) {
    ...
    Node internalInsertBefore(Node newChild, Node refChild, boolean replace) 
        ...
        if (errorChecking) {
            ...
            for (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl a = this; treeSafe && a != null; a = a.parentNode())
            {
                treeSafe = newChild != a;
            }
            if(!treeSafe) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode newInternal = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode)newChild;
        ...
        // Convert to internal type, to avoid repeated casting
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode refInternal = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode)refChild;
        ...
        if (firstChild == null) {
            ...
            if (refInternal == null) {
                // this is an append
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode lastChild = firstChild.previousSibling;
                ...
                if (refChild == firstChild) {
                    ...
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode prev = refInternal.previousSibling;
    ...
    Node internalRemoveChild(Node oldChild, boolean replace)
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode oldInternal = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode) oldChild;

        // notify document
        ownerDocument.removingNode(this, oldInternal, replace);
        
        // Save previous sibling for normalization checking.
        final org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode oldPreviousSibling = oldInternal.previousSibling();
        ...
        if (oldInternal == firstChild) {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode prev = oldInternal.previousSibling;
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode next = oldInternal.nextSibling;
    ...
    public String getTextContent() throws DOMException {
        ...
        if (child != null) {
            ...
            if (next == null) {
                return hasTextContent(child) ? ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) child).getTextContent() : "";
            }
    ...
    private int nodeListGetLength() {
        ...
        if (fNodeListCache.fLength == -1) { // is the cached length invalid ?
            int l;
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode n;
    ...
    private Node nodeListItem(int index) {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode n = fNodeListCache.fChild;
    ...
    public void normalize() {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode kid;
    ...
    public void setReadOnly(boolean readOnly, boolean deep) {
        ...
        if (deep) {
            ...
            for (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode mykid = firstChild;
                 mykid != null;
     ...
     */
    void checkNormalizationAfterInsert(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode insertedChild) {
        // See if insertion caused this node to be unnormalized.
        if (insertedChild.getNodeType() == Node.TEXT_NODE) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode prev = insertedChild.previousSibling();
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode next = insertedChild.nextSibling;
     ...
     * <code>null</code>
     */
    void checkNormalizationAfterRemove(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode previousSibling) {
