 ...
 * @version $Id$
 */
class XSDAttributeTraverser extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDAbstractTraverser {
    
    public XSDAttributeTraverser (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler handler,
    ...
    protected XSAttributeUseImpl traverseLocal(Element attrDecl,
        ...
        XInt   useAtt     = (XInt)   attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_USE];
        ...
        if (attrDecl.getAttributeNode(SchemaSymbols.ATT_REF) != null) {
            if (refAtt != null) {
                attribute = (XSAttributeDecl)fSchemaHandler.getGlobalDecl(schemaDoc, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler.ATTRIBUTE_TYPE, refAtt, attrDecl);
