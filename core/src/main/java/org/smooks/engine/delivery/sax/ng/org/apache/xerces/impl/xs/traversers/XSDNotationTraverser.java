 ...
 * @version $Id$
 */
class  XSDNotationTraverser extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDAbstractTraverser {
    ...
    XSNotationDecl traverse(Element elmNode,
        ...
        //get attributes
        String  nameAttr   = (String) attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAME];
        
        String  publicAttr = (String) attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_PUBLIC];
