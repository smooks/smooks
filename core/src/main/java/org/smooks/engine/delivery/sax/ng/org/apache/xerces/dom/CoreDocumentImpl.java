...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CDATASectionImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.CommentImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMNormalizer;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.EntityImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeListCache;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NotationImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ObjectFactory;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ParentNode;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.TextImpl;
...
extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ParentNode implements Document  {
    ...
    /** Document element. */
    protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl docElement;

    /** NodeListCache free list */
    transient org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeListCache fFreeNLCache;
    ...
    transient org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DOMNormalizer domNormalizer = null;
    ...
    throws DOMException {
        ...
        if (type == Node.ELEMENT_NODE) {
            docElement = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl)newChild;
        }
    ...
    public Object getFeature(String feature, String version) {
        ...
        if ((feature.equalsIgnoreCase("+XPath"))
            ...
            try {
                Class xpathClass = org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ObjectFactory.findProviderClass(
                    "org.apache.xpath.domapi.XPathEvaluatorImpl",
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ObjectFactory.findClassLoader(), true);
    ...
    public Attr createAttribute(String name)
        ...
        return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl(this, name);
    ...
    throws DOMException {
        ...
        return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl(this, tagName);
     ...
     */
    protected boolean canRenameElements(String newNamespaceURI, String newNodeName, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl el) {
        return true;
    }
    ...
    throws DOMException{
        ...
        switch (n.getNodeType()) {
            case ELEMENT_NODE: {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl el = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl) n;
                if (el instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementNSImpl) {
                    if (canRenameElements(namespaceURI, name, el)) {
                        ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementNSImpl) el).rename(namespaceURI, name);
            ...
            case ATTRIBUTE_NODE: {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl at = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) n;
                ...
                if (n instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrNSImpl) {
                    ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrNSImpl) at).rename(namespaceURI, name);
                    ...
                    if (namespaceURI == null) {
                        ...
                        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrNSImpl nat = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrNSImpl) createAttributeNS(namespaceURI, name);
    ...
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl replaceRenameElement(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl el, String namespaceURI, String name) {
        
        // we need to create a new object
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementNSImpl nel = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementNSImpl)createElementNS(namespaceURI, name);
    ...
    throws DOMException {
        ...
        return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.EntityImpl(this, name);
    ...
    throws DOMException {
        ...
        return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NotationImpl(this, name);
    ...
    throws DOMException {
        ...
        // }
        // else
		if(source instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)
			userData = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)source).getUserDataRecord();
        ...
        switch (type) {
            ...
            case ATTRIBUTE_NODE: {
                ...
                if (source instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) {
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) source;
                    if (attr.hasStringValue()) {
                        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl newattr = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) newnode;
            ...
            case ENTITY_NODE: {
                ...
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.EntityImpl newentity =
            ...
            case NOTATION_NODE: {
                ...
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NotationImpl newnotation =
        ...
        if (newnode.getNodeType() == Node.ENTITY_NODE) {
            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)newnode).setReadOnly(true, true);
        }
        return newnode;
    ...
    public Node adoptNode(Node source) {
        ...
        switch (node.getNodeType()) {
            case ATTRIBUTE_NODE: {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) node;
    ...
    protected void undeferChildren(Node node) {
        ...
        while (null != node) {
            ...
            if (((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)node).needsSyncData()) {
                ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)node).synchronizeData();
            }
    ...
    throws DOMException {
        return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementNSImpl(this, namespaceURI, qualifiedName);
    }
    ...
    throws DOMException {
        return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrNSImpl(this, namespaceURI, qualifiedName);
    }
     ...
     */
    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeListCache getNodeListCache(ParentNode owner) {
        if (fFreeNLCache == null) {
            return new org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeListCache(owner);
        }
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeListCache c = fFreeNLCache;
     ...
     */
    void freeNodeListCache(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeListCache c) {
        c.next = fFreeNLCache;
        fFreeNLCache = c;
    }
     ...
     */
    protected void setUserData(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl n, Object data) {
     ...
     */
    protected Object getUserData(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl n) {
    ...
    protected void addEventListener(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, String type,
                                    EventListener listener,
                                    boolean useCapture) {
        // does nothing by default - overidden in subclass
    }

    protected void removeEventListener(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, String type,
                                       EventListener listener,
                                       boolean useCapture) {
        // does nothing by default - overidden in subclass
    }

    protected void copyEventListeners(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl src, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl tgt) {
        // does nothing by default - overidden in subclass
    }

    protected boolean dispatchEvent(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, Event event) {
        // does nothing by default - overidden in subclass
        return false;
    }
     ...
     */
    void modifyingCharacterData(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, boolean replace) {
    }

    /**
     * A method to be called when a character data node has been modified
     */
    void modifiedCharacterData(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, String oldvalue, String value, boolean replace) {
    }

    /**
     * A method to be called when a node is about to be inserted in the tree.
     */
    void insertingNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, boolean replace) {
    }

    /**
     * A method to be called when a node has been inserted in the tree.
     */
    void insertedNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl newInternal, boolean replace) {
    }

    /**
     * A method to be called when a node is about to be removed from the tree.
     */
    void removingNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl oldChild, boolean replace) {
    }

    /**
     * A method to be called when a node has been removed from the tree.
     */
    void removedNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, boolean replace) {
    }

    /**
     * A method to be called when a node is about to be replaced in the tree.
     */
    void replacingNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node) {
    }

    /**
     * A method to be called when a node has been replaced in the tree.
     */
    void replacedNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node) {
    }

    /**
     * A method to be called when a character data node is about to be replaced
     */
    void replacingData(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node) {
    }

    /**
     *  method to be called when a character data node has been replaced.
     */
    void replacedCharacterData(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl node, String oldvalue, String value) {
    }
     ...
     */
    void modifiedAttrValue(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr, String oldvalue) {
    }

    /**
     * A method to be called when an attribute node has been set
     */
    void setAttrNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr, org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl previous) {
    }
