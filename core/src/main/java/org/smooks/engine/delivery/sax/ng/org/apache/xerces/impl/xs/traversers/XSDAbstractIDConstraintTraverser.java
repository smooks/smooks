 ...
 * @version $Id$
 */
class XSDAbstractIDConstraintTraverser extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDAbstractTraverser {
    ...
    boolean traverseIdentityConstraint(IdentityConstraint ic,
                                       Element icElem, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDocumentInfo schemaDoc, Object [] icElemAttrs) {
        ...
        String sText = ((String)attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_XPATH]);
        if(sText == null) {
