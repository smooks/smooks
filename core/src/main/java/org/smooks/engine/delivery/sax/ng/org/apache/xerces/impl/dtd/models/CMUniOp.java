 ...
 * @version $Id$
 */
public class CMUniOp extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode
{
    // -------------------------------------------------------------------
    //  Constructors
    // -------------------------------------------------------------------
    public CMUniOp(int type, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode childNode) 
    {
        super(type);
    ...
    // -------------------------------------------------------------------
    final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dtd.models.CMNode getChild()
    {
        return fChild;
    }
