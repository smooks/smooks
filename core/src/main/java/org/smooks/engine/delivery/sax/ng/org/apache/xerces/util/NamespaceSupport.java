...
public class NamespaceSupport implements NamespaceContext {
    ...
    public void reset() {
        ...
        fNamespace[fNamespaceSize++] = org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLSymbols.PREFIX_XML;
        fNamespace[fNamespaceSize++] = NamespaceContext.XML_URI;
        // bind "xmlns" prefix to the XMLNS uri
        fNamespace[fNamespaceSize++] = org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLSymbols.PREFIX_XMLNS;
    ...
    public boolean declarePrefix(String prefix, String uri) {
        ...
        if (prefix == org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLSymbols.PREFIX_XML || prefix == XMLSymbols.PREFIX_XMLNS) {
            return false;
        }
