...
public class AttributeMap extends NamedNodeMapImpl {
    ...
    protected AttributeMap(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl ownerNode, NamedNodeMapImpl defaults) {
        super(ownerNode);
        if (defaults != null) {
    ...
    throws DOMException {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl argn = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)arg;
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl previous = null;
        if (i >= 0) {
            previous = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) nodes.get(i);
            nodes.set(i, arg);
    ...
    protected Node removeItem(Node item, boolean addDefault)
        ...
        return remove((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)item, index, addDefault);
    }
    ...
    final protected Node internalRemoveNamedItem(String name, boolean raiseEx){
        ...
        return remove((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)nodes.get(i), i, true);

    } // internalRemoveNamedItem(String,boolean):Node

    private final Node remove(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr, int index,
                              boolean addDefault) {
        ...
        if (hasDefaults() && addDefault) {
            ...
            NamedNodeMapImpl defaults =
                ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl) ownerNode).getDefaultAttributes();

            Node d;
            if (defaults != null &&
                (d = defaults.getNamedItem(name)) != null &&
                findNamePoint(name, index+1) < 0) {
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl clone = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl)d.cloneNode(true);
                    if (d.getLocalName() !=null){
                            ...
                            ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrNSImpl)clone).namespaceURI = attr.getNamespaceURI();
                    } 
                    ...
                    if (attr.isIdAttribute()) {
                        ownerDocument.putIdentifier(clone.getNodeValue(),
                                                (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl)ownerNode);
                    }
            } else {
                nodes.remove(index);
            }
    ...
    final protected Node internalRemoveNamedItemNS(String namespaceURI,
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl n = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl)nodes.get(i);
        ...
        if (hasDefaults()) {
            NamedNodeMapImpl defaults = ((org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ElementImpl) ownerNode).getDefaultAttributes();
            Node d;
            if (defaults != null
    ...
    public NamedNodeMapImpl cloneMap(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl ownerNode) {
        AttributeMap newmap =
    ...
    protected void cloneContent(NamedNodeMapImpl srcmap) {
        ...
        if (srcnodes != null) {
            ...
            if (size != 0) {
                ...
                for (int i = 0; i < size; ++i) {
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl n = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) srcnodes.get(i);
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl clone = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl) n.cloneNode(true);
    ...
    void moveSpecifiedAttributes(AttributeMap srcmap) {
        ...
        for (int i = nsize - 1; i >= 0; i--) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) srcmap.nodes.get(i);
            if (attr.isSpecified()) {
    ...
    protected void reconcileDefaults(NamedNodeMapImpl defaults) {
        ...
        for (int i = nsize - 1; i >= 0; --i) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) nodes.get(i);
            if (!attr.isSpecified()) {
                remove(attr, i, false);
            }
        }
        ...
        if (nodes == null || nodes.size() == 0) {
            ...
            for (int n = 0; n < dsize; ++n) {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl d = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl) defaults.nodes.get(n);
                int i = findNamePoint(d.getNodeName(), 0); 
                if (i < 0) {
            		i = -1 - i; 
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl clone = (NodeImpl) d.cloneNode(true);
                    clone.ownerNode = ownerNode;
                    clone.isOwned(true);
                    clone.isSpecified(false);
            		nodes.add(i, clone);
    ...
    protected final int addItem (Node arg) {
        ...
        final org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl argn = (AttrImpl) arg;
