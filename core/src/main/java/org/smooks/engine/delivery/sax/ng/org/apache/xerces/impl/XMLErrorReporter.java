...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.ErrorHandlerProxy;
...
public class XMLErrorReporter
    ...
    protected static final String CONTINUE_AFTER_FATAL_ERROR =
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.XERCES_FEATURE_PREFIX + org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.CONTINUE_AFTER_FATAL_ERROR_FEATURE;

    // property identifiers

    /** Property identifier: error handler. */
    protected static final String ERROR_HANDLER =
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.XERCES_PROPERTY_PREFIX + org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.ERROR_HANDLER_PROPERTY;
    ...
    public void setFeature(String featureId, boolean state)
        ...
        if (featureId.startsWith(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.XERCES_FEATURE_PREFIX)) {
            ...
            //
            if (suffixLength == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.CONTINUE_AFTER_FATAL_ERROR_FEATURE.length() && 
                featureId.endsWith(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.CONTINUE_AFTER_FATAL_ERROR_FEATURE)) {
    ...
    public void setProperty(String propertyId, Object value)
        ...
        if (propertyId.startsWith(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.XERCES_PROPERTY_PREFIX)) {
            ...
            if (suffixLength == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.Constants.ERROR_HANDLER_PROPERTY.length() && 
