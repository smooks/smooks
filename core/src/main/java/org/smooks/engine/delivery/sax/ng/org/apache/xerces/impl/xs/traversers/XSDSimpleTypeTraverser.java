 ...
 * @version $Id$
 */
class XSDSimpleTypeTraverser extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDAbstractTraverser {
    
    // whether the type being parsed is a S4S built-in type.
    private boolean fIsBuiltIn = false;
    
    XSDSimpleTypeTraverser (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler handler,
    ...
    XSSimpleType traverseGlobal(Element elmNode,
        ...
        if (nameAtt == null) {
            attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAME] = NO_NAME;
        }
    ...
    private XSSimpleType traverseSimpleTypeDecl(Element simpleTypeDecl,
        ...
        String name = (String)attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAME];
     ...
     * @return
     */
    private XSSimpleType getSimpleType(String name, Element simpleTypeDecl, Object[] attrValues, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDocumentInfo schemaDoc, SchemaGrammar grammar) {
        XInt finalAttr = (XInt)attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_FINAL];
        ...
        QName baseTypeName = (QName)contentAttrs[restriction ?
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_BASE :
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_ITEMTYPE];
