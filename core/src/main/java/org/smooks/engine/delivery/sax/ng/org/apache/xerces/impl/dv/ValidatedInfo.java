...
public class ValidatedInfo implements XSValue {
     ...
     */
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType actualType;

    /**
     * If the type is a union type, then the member type which
     * actually validated the string value.
     */
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType memberType;
     ...
     */
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType[] memberTypes;
    ...
    public void copyFrom(XSValue o) {
        if (o == null) {
            ...
            actualType = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType)o.getTypeDefinition();
            memberType = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType)o.getMemberTypeDefinition();
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType realType = memberType == null ? actualType : memberType;
            if (realType != null && realType.getBuiltInKind() == XSConstants.LISTOFUNION_DT) {
                XSObjectList members = o.getMemberTypeDefinitions();
                memberTypes = new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.XSSimpleType[members.getLength()];
