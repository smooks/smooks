 ...
 * @version $Id$
 */
class XSDAttributeGroupTraverser extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDAbstractTraverser {
    
    XSDAttributeGroupTraverser (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler handler,
    ...
    XSAttributeGroupDecl traverseLocal(Element elmNode,
        ...
        // get attribute
        QName   refAttr	= (QName)   attrValues[org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSAttributeChecker.ATTIDX_REF];
        ...
        // get global decl
        attrGrp = (XSAttributeGroupDecl)fSchemaHandler.getGlobalDecl(schemaDoc, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.traversers.XSDHandler.ATTRIBUTEGROUP_TYPE, refAttr, elmNode);
