...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.ShadowedSymbolTable;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.SymbolTable;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.SynchronizedSymbolTable;
...
public class CachingParserPool {
    ...
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.DOMParser createDOMParser() {
    ...
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.parsers.SAXParser createSAXParser() {
        SymbolTable symbolTable = fShadowSymbolTable
                                ? new ShadowedSymbolTable(fSynchronizedSymbolTable)
                                : fSynchronizedSymbolTable;
        XMLGrammarPool grammarPool = fShadowGrammarPool
