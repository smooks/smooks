...
implements EntityReference {
    ...
    public String getBaseURI() {
        ...
        if (baseURI == null) {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.EntityImpl entDef;
            if (null != (doctype = getOwnerDocument().getDoctype()) && 
                null != (entities = doctype.getEntities())) {

                entDef = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.EntityImpl)entities.getNamedItem(getNodeName());
                if (entDef !=null) {
    ...
    protected String getEntityRefValue (){
        ...
        if (firstChild != null){
          ...
          if (firstChild.nextSibling == null){
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode next = firstChild.nextSibling;
            while (next != null){   
