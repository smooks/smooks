...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredAttrImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredAttrNSImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredCommentImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredElementImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredEntityImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredNode;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredTextImpl;
...
public class DeferredDocumentImpl
    extends org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DocumentImpl
	...
	public int setDeferredAttribute(int elementNodeIndex,
		...
		if (type != null) {
			int extraDataIndex = createNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredNode.TYPE_NODE);
			int echunk = extraDataIndex >> CHUNK_SHIFT;
			int eindex = extraDataIndex & CHUNK_MASK;
    ...
    public int createDeferredAttribute(String attrName, String attrURI,
        ...
        // create node
        int nodeIndex = createNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl.ATTRIBUTE_NODE);
        int chunk = nodeIndex >> CHUNK_SHIFT;
        int index = nodeIndex & CHUNK_MASK;
    ...
    public int createDeferredElementDefinition(String elementName) {
        ...
        // create node
        int nodeIndex = createNode(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl.ELEMENT_DEFINITION_NODE);
        int chunk = nodeIndex >> CHUNK_SHIFT;
        int index = nodeIndex & CHUNK_MASK;
        ...
        if (fNodeCount > 1) {
            ...
            for (int index = getChunkIndex(fNodeLastChild, nchunk, nindex);
                ...
                if (getChunkIndex(fNodeType, nchunk, nindex) ==
                                           org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.NodeImpl.ELEMENT_DEFINITION_NODE
    ...
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredNode getNodeObject(int nodeIndex) {
        ...
        // create new node
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredNode node = null;
        switch (type) {
            ...
            case Node.DOCUMENT_TYPE_NODE: {
                ...
                docType = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DocumentTypeImpl)node;
                break;
            }
            ...
            for (int i = 0; i < fNodeType.length; i++) {
                if (fNodeType[i] != null) {
                    ...
                    switch (fNodeType[i][CHUNK_SIZE]) {
                        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DocumentImpl.ELEMENT_DEFINITION_NODE: { System.out.print("EDef"); break; }
                        ...
                        case org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredNode.TYPE_NODE: { System.out.print("TypeInfo"); break; }
        ...
        if (fIdElement != null) {
            ...
            for (int i = 0; i < fIdCount; i++) {
                ...
                for (int j = path.size() - 2; j >= 0; j--) {
                    ...
                    while (child != null) {
                        if (child instanceof org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredNode) {
                            int nodeIndex =
    ...
    protected void synchronizeChildren() {
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode first = null;
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode last = null;
        for (int index = getLastChild(0);
             index != -1;
             index = getPrevSibling(index)) {

            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode node = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode)getNodeObject(index);
            if (last == null) {
                last = node;
            }
            else {
    ...
    protected final void synchronizeChildren(AttrImpl a, int nodeIndex) {
        ...
        if (prev == -1) {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode firstNode = null;
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode lastNode = null;
    ...
    protected final void synchronizeChildren(ParentNode p, int nodeIndex) {
        ...
        for (int index = getLastChild(nodeIndex);
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.ChildNode node = (ChildNode) getNodeObject(index);
            if (lastNode == null) {
                lastNode = node;
            }
            else {
