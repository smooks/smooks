...
public class XSConstraints {
    ...
    static final int OCCURRENCE_UNKNOWN = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED-1;
    static final XSSimpleType STRING_TYPE = (XSSimpleType) org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.SG_SchemaNS.getGlobalTypeDecl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.ATTVAL_STRING);
    ...
    public static boolean checkTypeDerivationOk(XSTypeDefinition derived, XSTypeDefinition base, short block) {
        ...
        if (derived == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType)
            return derived == base;
        // if derived is anySimpleType, then it's valid only if the base
        // is ur-type
        if (derived == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnySimpleType) {
            return (base == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType ||
                    base == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnySimpleType);
        }
        ...
        if (derived.getTypeCategory() == XSTypeDefinition.SIMPLE_TYPE) {
            ...
            if (base.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
                ...
                // otherwise, not valid
                if (base == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType)
                    base = org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnySimpleType;
                else
                    return false;
            }
    ...
    private static boolean checkSimpleDerivation(XSSimpleType derived, XSSimpleType base, short block) {
        ...
        if (directBase != org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnySimpleType &&
    ...
    private static boolean checkComplexDerivation(XSComplexTypeDecl derived, XSTypeDefinition base, short block) {
        ...
        if (directBase == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnyType ||
                directBase == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar.fAnySimpleType) {
            return false;
        }
    ...
    public static void fullSchemaChecking(XSGrammarBucket grammarBucket,
        ...
        org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaGrammar[] grammars = grammarBucket.getGrammars();
        ...
        for (int g = grammars.length-1; g >= 0; g--) {
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl[] redefinedGroups = grammars[g].getRedefinedGroupDecls();
            SimpleLocator [] rgLocators = grammars[g].getRGLocators();
            for(int i=0; i<redefinedGroups.length; ) {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.XSGroupDecl derivedGrp = redefinedGroups[i++];
            ...
            case XSModelGroupImpl.MODELGROUP_SEQUENCE:
            {
                switch (bType) {
                    ...
                    case XSModelGroupImpl.MODELGROUP_CHOICE:
                    {
                        ...
                        int max1 = (dMaxOccurs == org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED)?
    ...
    private static void checkNameAndTypeOK(XSElementDecl dElement, int dMin, int dMax,
        ...
        if (!checkOccurrenceRange(dMin, dMax, bMin, bMax)) {
            throw new XMLSchemaException("rcase-NameAndTypeOK.3",
                    ...
                    dMax== org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(dMax),
                            Integer.toString(bMin),
                            bMax== org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(bMax)});
        }
    ...
    private static boolean checkOccurrenceRange(int min1, int max1, int min2, int max2) {
        ...
        if ((min1 >= min2) &&
                ((max2== org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED) ||
                        (max1!= org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED && max1<=max2)))
            return true;
        else
            return false;
    }
    ...
    private static void checkNSCompat(XSElementDecl elem, int min1, int max1,
        ...
        if (checkWCOccurrence && !checkOccurrenceRange(min1,max1,min2,max2)) {
            throw new XMLSchemaException("rcase-NSCompat.2",
                    ...
                    max1== org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(max1),
                            Integer.toString(min2),
                            max2== org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(max2)});
        }
