...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xinclude.XIncludeHandler;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xinclude.XIncludeNamespaceSupport;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.*;
...
public final class XPointerHandler extends XIncludeHandler implements
    ...
    protected org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart fXPointerPart = null;
   ...
   // Has the XPointer resolved the subresource
    ...
    public void parseXPointer(String xpointer) throws XNIException {
        ...
        while (tokens.hasMore()) {
            ...
            case Tokens.XPTRTOKEN_SHORTHAND: {
                ...
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart shortHandPointer = new ShortHandPointer(
                        fSymbolTable);
            ...
            case Tokens.XPTRTOKEN_SCHEMENAME: {
                ...
                if (schemeName.equals(ELEMENT_SCHEME_NAME)) {
                    org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart elementSchemePointer = new ElementSchemePointer(
    ...
    public boolean resolveXPointer(QName element, XMLAttributes attributes,
        ...
        if (!fFoundMatchingPtrPart) {
            ...
            for (int i = 0; i < fXPointerParts.size(); i++) {
                ...
                fXPointerPart = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart) fXPointerParts.get(i);
     ...
     * 
     * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart#isChildFragmentResolved()
     *   
     */
     ...
     */
    public org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart getXPointerPart() {
    ...
    public void startElement(QName element, XMLAttributes attributes,
        ...
        if (!resolveXPointer(element, attributes, augs,
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart.EVENT_ELEMENT_START)) {
    ...
    public void emptyElement(QName element, XMLAttributes attributes,
            Augmentations augs) throws XNIException {
        if (!resolveXPointer(element, attributes, augs,
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.xpointer.XPointerPart.EVENT_ELEMENT_EMPTY)) {
            // xml:base and xml:lang processing
        	if (fFixupBase) {
                processXMLBaseAttributes(attributes);
        	}    
