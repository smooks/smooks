...
public class XMLDTDScannerImpl
    ...
    public XMLDTDScannerImpl(SymbolTable symbolTable,
                             org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.XMLErrorReporter errorReporter, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.XMLEntityManager entityManager) {
...
//                       "OPEN_PAREN_REQUIRED_BEFORE_ENUMERATION_IN_ATTRDECL",
    ...
    private final void scanEntityDecl() throws IOException, XNIException {
        ...
        if (systemId != null) {
            ...
            if (fDTDHandler != null) {
                fResourceIdentifier.setValues(publicId, systemId, baseSystemId, org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.XMLEntityManager.expandSystemId(systemId, baseSystemId, false));
                if (notation != null) {
