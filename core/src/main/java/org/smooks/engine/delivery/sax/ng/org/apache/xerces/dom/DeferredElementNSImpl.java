...
public class DeferredElementNSImpl
     ...
     */
    DeferredElementNSImpl(org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.DeferredDocumentImpl ownerDoc, int nodeIndex) {
        super(ownerDoc, null);
    ...
    protected final void synchronizeData() {
        ...
        if (attrIndex != -1) {
            ...
            do {
                org.smooks.engine.delivery.sax.ng.org.apache.xerces.dom.AttrImpl attr = (AttrImpl) ownerDocument.getNodeObject(attrIndex);
