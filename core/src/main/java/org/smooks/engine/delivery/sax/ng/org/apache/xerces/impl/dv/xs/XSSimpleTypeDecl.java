...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.InvalidDatatypeFacetException;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.*;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.AnyAtomicDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.AnySimpleDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.AnyURIDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.Base64BinaryDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.BooleanDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DateDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DateTimeDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DayDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DecimalDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DoubleDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.DurationDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.EntityDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.FloatDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.HexBinaryDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.IDDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.IDREFDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.IntegerDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.ListDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.MonthDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.MonthDayDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.QNameDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.StringDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.TimeDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.TypeValidator;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.UnionDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.YearDV;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.YearMonthDV;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.ObjectListImpl;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.xs.util.ShortListImpl;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSFacet;
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSMultiValueFacet;
...
import org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.datatypes.ObjectList;
...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
    ...
    private static final org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.TypeValidator[] gDVs = {
        new AnySimpleDV(),
        new StringDV(),
        new BooleanDV(),
        new DecimalDV(),
        ...
        new Base64BinaryDV(),
        new AnyURIDV(),
        new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.QNameDV(),
        ...
        new EntityDV(),
        new IntegerDV(),
        new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.ListDV(),
        new UnionDV(),
        new YearMonthDurationDV(), // XML Schema 1.1 type
        new DayTimeDurationDV(), // XML Schema 1.1 type
        new org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.AnyAtomicDV() // XML Schema 1.1 type
    };
    ...
    protected static org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.TypeValidator[] getGDVs() {
        return (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.TypeValidator[])gDVs.clone();
    }
    private org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.TypeValidator[] fDVs = gDVs;
    ...
    private void checkExtraRules(ValidationContext context, ValidatedInfo validatedInfo) throws InvalidDatatypeValueException {
        ...
        if (fVariety == VARIETY_ATOMIC) {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.ListDV.ListData values = (org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.ListDV.ListData)ob;
    ...
    throws InvalidDatatypeValueException{
        ...
        if (fVariety == VARIETY_ATOMIC) {
            ...
            org.smooks.engine.delivery.sax.ng.org.apache.xerces.impl.dv.xs.ListDV.ListData v = new ListDV.ListData(avalue);
    ...
    private static final class XSFacetImpl implements XSFacet {
         ...
         * (non-Javadoc)
         * 
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSFacet#getAnnotation()
         */
        /**
         * Optional. Annotation.
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSFacet#getAnnotations()
         */
        /**
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSFacet#getFacetKind()
         */
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSFacet#getLexicalFacetValue()
         */
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSFacet#isFixed()
         */
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSObject#getName()
         */
        public String getName() {
            return null;
        }
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSObject#getNamespace()
         */
        public String getNamespace() {
            return null;
        }
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSObject#getType()
         */
        public short getType() {
    ...
    private static final class XSMVFacetImpl implements XSMultiValueFacet {
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSMultiValueFacet#getAnnotations()
         */
        public XSObjectList getAnnotations() {
            return annotations;
        }
        ...
        /* (non-Javadoc)
         * @see org.smooks.engine.delivery.sax.ng.org.apache.xerces.xs.XSMultiValueFacet#getLexicalFacetValues()
         */
