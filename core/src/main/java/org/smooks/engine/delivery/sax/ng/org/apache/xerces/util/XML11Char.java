    ...
    public static boolean isXML11ValidName(String name) {
        ...
        if (!isXML11NameStart(ch)) {
            if (length > 1 && isXML11NameHighSurrogate(ch)) {
                ...
                if (!org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.isLowSurrogate(ch2) || 
                    !isXML11NameStart(org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.supplemental(ch, ch2))) {
                    return false;
                }
                i = 2;
            }
        ...
        while (i < length) {
            ...
            if (!isXML11Name(ch)) {
                if (++i < length && isXML11NameHighSurrogate(ch)) {
                    ...
                    if (!org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.isLowSurrogate(ch2) || 
                        !isXML11Name(org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.supplemental(ch, ch2))) {
                        return false;
                    }
                }
                else {
    ...
    public static boolean isXML11ValidNCName(String ncName) {
        ...
        if (!isXML11NCNameStart(ch)) {
            if (length > 1 && isXML11NameHighSurrogate(ch)) {
                ...
                if (!org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.isLowSurrogate(ch2) || 
                    !isXML11NCNameStart(org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.supplemental(ch, ch2))) {
                    return false;
                }
                i = 2;
            }
        ...
        while (i < length) {
            ...
            if (!isXML11NCName(ch)) {
                if (++i < length && isXML11NameHighSurrogate(ch)) {
                    ...
                    if (!org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.isLowSurrogate(ch2) || 
                        !isXML11NCName(org.smooks.engine.delivery.sax.ng.org.apache.xerces.util.XMLChar.supplemental(ch, ch2))) {
                        return false;
                    }
                }
                else {
