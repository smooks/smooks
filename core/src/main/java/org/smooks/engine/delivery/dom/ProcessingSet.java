...
public class ProcessingSet {
	 ...
	 * @param domElementVisitor The Processing Unit to be added.
	...
	public void addProcessingUnit(DOMElementVisitor domElementVisitor, ResourceConfig resourceConfig) {
		ContentHandlerBinding<DOMElementVisitor> contentHandlerBinding = new DefaultContentHandlerBinding<>(domElementVisitor, resourceConfig);
