 ...
 */
public class BigDecimalToStringConverterFactory implements TypeConverterFactory<BigDecimal, String> {
    @Override
    ...
    public TypeConverterDescriptor<Class<BigDecimal>, Class<String>> getTypeConverterDescriptor() {
        return new DefaultTypeConverterDescriptor<>(BigDecimal.class, String.class);
    }
}
