 ...
 */
public class DoubleToStringConverterFactory implements TypeConverterFactory<Double, String> {
    ...
    public TypeConverterDescriptor<Class<Double>, Class<String>> getTypeConverterDescriptor() {
        return new DefaultTypeConverterDescriptor<>(Double.class, String.class);
    }
}
