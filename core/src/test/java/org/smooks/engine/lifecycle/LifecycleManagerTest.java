...
public class LifecycleManagerTest {
    ...
    public void test_parameterSetting_Config_setConfiguration_on_private_inner_class() {
        ...
        try {
            ...
            assertEquals("Error invoking 'setConfiguration' method on class 'org.smooks.engine.lifecycle.LifecycleManagerTest$MyContentDeliveryUnit4'.  This class must be public.  Alternatively, use the @Inject annotation on a class field.", e.getMessage());
        }
    }
    ...
    public void test_paramaterSetting_decode_error() {
        ...
        try {
            ...
            assertEquals("Failed to set parameter configuration value on 'org.smooks.engine.lifecycle.LifecycleManagerTest$MyContentDeliveryUnit7#encoding'.", e.getMessage());
    ...
    public void test_paramaterSetting_setterMethod() {
        ...
        try {
            ...
            assertEquals("Unable to determine the property name associated with 'org.smooks.engine.lifecycle.LifecycleManagerTest$MyContentDeliveryUnit9#encoding'. " +
    ...
    public void test_Initialize_Uninitialize() {
        ...
        try {
            ...
            assertEquals("Error invoking @PostConstruct method 'init' on class 'org.smooks.engine.lifecycle.LifecycleManagerTest$MyContentDeliveryUnit12'.", e.getMessage());
        }
        ...
        try {
            ...
            assertEquals("Error invoking @PreDestroy method 'uninit' on class 'org.smooks.engine.lifecycle.LifecycleManagerTest$MyContentDeliveryUnit12'.", e.getMessage());
        }
    }
