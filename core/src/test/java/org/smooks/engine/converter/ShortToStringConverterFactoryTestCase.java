 ...
 */
public class ShortToStringConverterFactoryTestCase {
    ...
    public void test_encode_format_config() {
        ShortToStringConverterFactory shortToStringConverterFactory = new ShortToStringConverterFactory();
        Properties config = new Properties();

        config.setProperty(NumberTypeConverter.FORMAT, "#,###.##");
        TypeConverter<Short, String> typeConverter = shortToStringConverterFactory.createTypeConverter();
    ...
    public void test_encode_locale_config() {
        ...
        assertEquals("1234", typeConverter.convert((short)1234));
    }
}
