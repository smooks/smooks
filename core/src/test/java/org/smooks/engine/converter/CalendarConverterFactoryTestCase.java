 ...
 */
public class CalendarConverterFactoryTestCase {

    @Test
    public void testCalendarDecoder() {
        ...
        Calendar cal_a = typeConverter.convert("Wed Nov 15 13:45:28 GMT-05:00 2006");
        ...
        Calendar cal_b = typeConverter.convert("Wed Nov 15 13:45:28 GMT-05:00 2006");
        assertNotSame(cal_a, cal_b);
    }

    @Test
	@EnabledForJreRange(max = JRE.JAVA_10)
    public void testCalendarDecoderWithSwedishLocalWhenLessThanJava11() throws ParseException {
    ...
    public void testCalendarDecoderWithSwedishLocal() throws ParseException {
        final String dateFormat = "EEE MMM dd HH:mm:ss z yyyy";
        ...
        ((Configurable) typeConverter).setConfiguration(config);
        Calendar cal_a = typeConverter.convert(dateString);
        assertEquals("centraleuropeisk normaltid", cal_a.getTimeZone().getDisplayName(new Locale("sv", "SE")));
